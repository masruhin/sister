<?php
//----------------------------------------------------------------------------------------------------
//Program		: A6U03_C02.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 26/12/2011
//Keterangan	: CETAK FORMAT RAPORT PS-JHS-SHS
//----------------------------------------------------------------------------------------------------
...
$Hlm=1;
	...
	while ($id<99)
	{
		...
		if(substr($nmasbj,0,1)=='/')
		{
			...
			$pdf->SetFont('Arial','B',8);
			$pdf->SetFillColor(204,204,204);
			$pdf->Cell(6.2	,0.4,$nmasbj,'LRTB',0,L,$bg);
		}
		else
		{
			$bg='false';
			...
			$pdf->Cell(0.6	,0.4,'','LRTB',0,C,$bg);
			$pdf->Cell(6.2	,0.4,$nmasbj,'LRTB',0,L,$bg);
		}	
		$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
		$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
		$pdf->Cell( 6.2	,0.4,'','LRTB',0,C,$bg);
		$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
		$pdf->Ln();
		$j++;
		$id=$cell[$j][0];
	...
	$pdf->Cell(6.2	,0.4,'Pengembangan Diri','LRTB',0,L,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 6.2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	...
	$pdf->Cell(6.2	,0.4,'Ekstrakulikuler','LRTB',0,L,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 6.2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	...
	$pdf->Cell( 8.8	,0.4,'Total','LRTB',0,C,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 8.2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Ln();
	$pdf->Cell( 8.8	,0.4,'Average','LRTB',0,C,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 8.2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Ln();
	$pdf->Cell( 8.8	,0.4,'Ranking','LRTB',0,C,$bg);
	$pdf->Cell( 2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Cell( 8.2	,0.4,'','LRTB',0,C,$bg);
	$pdf->Ln();
	...
	$pdf->SetFont('Arial','B',8);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 19	,0.4,"Homeroom Teacher's Comment",'LRTB',0,C,$bg);
	$pdf->Ln();
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 19	,0.4,"",'LRTB',0,C,$bg);
	$pdf->Ln();
	$pdf->Cell( 19	,0.4,"",'LRTB',0,C,$bg);
	$pdf->Ln();
	$pdf->SetFont('Arial','B',8);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 19	,0.4,"Parent's Comment",'LRTB',0,C,$bg);
	$pdf->Ln();
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 19	,0.4,"",'LRTB',0,C,$bg);
	...
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 6	,0.4,'Acknowledged by','',0,C,true);
	$pdf->Cell( 7	,0.4,'','',0,C,true);
	$pdf->Cell( 6	,0.4,'Bekasi, XXXXXXXXXXXXX 99, 9999','',0,C,true);
	$pdf->Ln();
	$pdf->Cell( 6	,0.4,'Parents / Guardian,','',0,C,true);
	$pdf->Cell( 7	,0.4,'','',0,C,true);
	$pdf->Cell( 6	,0.4,'Homeroom Teacher','',0,C,true);
	$pdf->Ln(2);
	$pdf->SetFont('Arial','U',8);
	$pdf->Cell( 6	,0.4,"                                                      ",'',0,C,true);
	$pdf->Cell( 7	,0.4,'','',0,C,true);
	$pdf->Cell( 6	,0.4,'XXXXXXXXXXXXXXXXXXXXX','',0,C,true);
	$pdf->Ln();
	$pdf->Cell( 6	,0.4,'','',0,C,true);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell( 7	,0.4,'Approved by','',0,C,true);
	$pdf->Cell( 6	,0.4,'','',0,C,true);
	$pdf->Ln(2);
	$pdf->Cell( 6	,0.4,'','',0,C,true);
	$pdf->SetFont('Arial','U',8);
	$pdf->Cell( 7	,0.4,'XXXXXXXXXXXXXXXXXXXXX','',0,C,true);
	$pdf->Cell( 6	,0.4,'','',0,C,true);
	$pdf->Ln();
	$pdf->Cell( 6	,0.4,'','',0,C,true);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell( 7	,0.4,'Principal','',0,C,true);
	$pdf->Cell( 6	,0.4,'','',0,C,true);
