<?php
//----------------------------------------------------------------------------------------------------
//Program		: G1D02_C03.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 26/12/2011
//Keterangan	: CETAK DAFTAR KARYAWAN ( DENGAN TANDA TANGAN )
//----------------------------------------------------------------------------------------------------
...
while ($j<$i)
{
	...
	$pdf->Cell( 3	,1);
	$pdf->Cell(10	,1, 'sciantia, virtus, et vita');//"Lumen Vitae"
	$pdf->SetFont('arial','B',8);
	$pdf->Cell( 6	,1, '','',0,R);//$nama_pt
	$pdf->SetFont('times','B',20);
	$pdf->Ln();
	$pdf->Cell( 3	,-0.1);
	$pdf->Cell(10	,-0.1, "Saint John's School");//$nama_pt
	$pdf->SetFont('arial','',6);
	...
	if($jnsklm!='')
	{
		$pdf->Cell( 2.1	,0.4,"Jekdekry Kelamin",0,0,L); 
		if($jnsklm=='L')
	...
	$pdf->Cell( 2	,0.5,'kdekry'			,'LRTB',0,C);
	...
	$pdf->Ln();
	$pdf->SetFont('Arial','',6);
	$pdf->Cell( 5	,0.4,'FORM : G1D02_C03 (PERSONALIA)');
