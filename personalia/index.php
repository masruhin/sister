...
<?php
	...
	else 
	{
		...
		$ret 		=mysql_query("	SELECT 	* 
									FROM 	t_mstkry 
									WHERE 	t_mstkry.usernm 	='".mysql_escape_string($username)."' 		AND 
											psswrd 	='". mysql_escape_string($password) ."'");//t_mstkry.kdekry 	='".mysql_escape_string($username)."' 		AND 
		...
		if (@mysql_num_rows($ret) != 0)	
		{
			...
			echo"<meta http-equiv=\"refresh\" content=\"1;url=personalia.php\">\n";	
		}
		else 
		{
			echo"
