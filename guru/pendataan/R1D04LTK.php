    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04LTK()
 	{
		...
		//R1D04LTK_C01
	 	...
	 	echo"
		<FORM ACTION='pendataan/R1D04LTK_C01_html.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT LEARNING RECORD K1</B></TD></TR>
           		<TR></TR><TR></TR>
