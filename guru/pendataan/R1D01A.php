		...
		<BODY onload='sf();'>
			...
			<FORM ID='validasi'  ACTION='guru.php'METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
				<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
					<TR><TD COLSPAN='2'><B><!--UPLOAD MATERIAL-->HANDOUT</B></TD></TR>
					<TR></TR><TR></TR>
				...
				<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
					...
					<TR>
						<TD ALIGN='left'>
							<INPUT TYPE='button' VALUE='New' onClick=window.location.href='guru.php?mode=R1D01A&pilihan=tambah_general'>";
							...
							if ($pilihan=='detil_general' or $pilihan=='tambah_item')
							{
								//echo"<INPUT TYPE='button' VALUE='Print' 	onClick=window.open('pendataan/R1D01A_Cetak.php?kdemtr=$kdemtr')>";
							}
						echo"
						</TD>
					</TR>
	...
	function R1D01A_Save_Item()
	{
        ...
        $set		="	SET     g_dtlmtr.kdemtr	='". mysql_escape_string($kdemtr)."',
                                g_dtlmtr.kdegru	='". mysql_escape_string($kdegru)."',
		   						g_dtlmtr.nmamtr	='". mysql_escape_string($nmamt)."',
