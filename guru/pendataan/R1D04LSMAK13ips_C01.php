<?php 
//----------------------------------------------------------------------------------------------------
//Program		: R1D04LSMAK13ips_C01.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 07/12/2011
//Keterangan	: Cetak SISWA ( versi 1 lembar ) ledger sma 10
//----------------------------------------------------------------------------------------------------
	...
	while($dataX =mysql_fetch_array($resultX))
	{
		...
		$qART	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									...
									t_prgrptps_sma_k13.kdeplj='ART' "; // menghasilkan nilai avehw art
		...
		$qCME	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='CME' "; // menghasilkan nilai avehw cme
		...
		$qBIN	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='BIN' "; // menghasilkan nilai avehw bin
...
//{
	...
	$pdf->Cell( 6.75	,0.5,'ECONOMY','LRTB',0,C,true);
	...
	while($dataY =mysql_fetch_array($resultY))
	{
		...
		$qENG	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='ENG' "; // menghasilkan nilai avehw eng
		...
		//grm
		$qGRM	 	="	SELECT 		t_prgrptps_sma_k13.*
						FROM 		t_prgrptps_sma_k13
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='GRM' "; // menghasilkan nilai avehw grm
		...
		$qECN	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='ECN' "; // menghasilkan nilai avehw ecn
...
//{
	...
	$pdf->SetFont('Arial','',7);
	$pdf->Cell( 6.75	,0.5,'GEOGRAPHY','LRTB',0,C,true);
	$pdf->Cell( 6.75	,0.5,'SOCIOLOGY','LRTB',0,C,true);
	$pdf->Cell( 6.75	,0.5,'SUPHIS','LRTB',0,C,true);
	...
	while($dataZ =mysql_fetch_array($resultZ))
	{
		...
		$qGGRY	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='GGRY' "; // menghasilkan nilai avehw ggry
		...
		$qSCL	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='SCL' "; // menghasilkan nilai avehw scl
		...
		while($dSCL =mysql_fetch_array($rSCL))
		{
			...
			$cSCL[$i][3]=$dSCL['avemid'."$sms"."$midtrm"];
			$cSCL[$i][4]=$dSCL['qg_k13_'."$sms"."$midtrm"]; // QG k13
			
			$cSCL[$i][5]=$dSCL['aveae'."$sms"."$midtrm"];
			$cSCL[$i][6]=$dSCL['aveaf'."$sms"."$midtrm"];
			$cSCL[$i][7]=$dSCL['aveag'."$sms"."$midtrm"];
			$cSCL[$i][8]=$dSCL['qg_k14_'."$sms"."$midtrm"]; // QG k14
		}
		...
		$qSHIST	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='SHIST' "; // menghasilkan nilai avehw shist
		$rSHIST =mysql_query($qSHIST) or die('Query gagal5');
		while($dSHIST =mysql_fetch_array($rSHIST))
		{
			$cSHIST[$i][0]=$dSHIST['avehw'."$sms"."$midtrm"];
			$cSHIST[$i][1]=$dSHIST['aveprj'."$sms"."$midtrm"];
			$cSHIST[$i][2]=$dSHIST['avetes'."$sms"."$midtrm"];
			$cSHIST[$i][3]=$dSHIST['avemid'."$sms"."$midtrm"];
			$cSHIST[$i][4]=$dSHIST['qg_k13_'."$sms"."$midtrm"]; // QG k13
			
			$cSHIST[$i][5]=$dSHIST['aveae'."$sms"."$midtrm"];
			$cSHIST[$i][6]=$dSHIST['aveaf'."$sms"."$midtrm"];
			$cSHIST[$i][7]=$dSHIST['aveag'."$sms"."$midtrm"];
			$cSHIST[$i][8]=$dSHIST['qg_k14_'."$sms"."$midtrm"]; // QG k14
		}
	...
	while($j<$i AND $x<=30)
	{
		...
		$qgSCL_k13=$cSCL[$j][4];
		$qgSCL_k14=$cSCL[$j][8];
		$aveSCL1314=($qgSCL_k13+$qgSCL_k14)/2;
		
		//shist
		$qgSHIST_k13=$cSHIST[$j][4];
		$qgSHIST_k14=$cSHIST[$j][8];
		$aveSHIST1314=($qgSHIST_k13+$qgSHIST_k14)/2;
		...
		//scl
		$pdf->SetFillColor(255,255,255); 
		$pdf->Cell( 0.5	,0.4,$cSCL[$j][0],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSCL[$j][1],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSCL[$j][2],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSCL[$j][3],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSCL[$j][4],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSCL[$j][5],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSCL[$j][6],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSCL[$j][7],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSCL[$j][8],'LRTB',0,C,true);
		$pdf->Cell( 0.75,0.4,$aveSCL1314,'LRTB',0,C,true);
		
		//shist
		$pdf->SetFillColor(255,255,255); 
		$pdf->Cell( 0.5	,0.4,$cSHIST[$j][0],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSHIST[$j][1],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSHIST[$j][2],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSHIST[$j][3],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSHIST[$j][4],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSHIST[$j][5],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSHIST[$j][6],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSHIST[$j][7],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSHIST[$j][8],'LRTB',0,C,true);
		$pdf->Cell( 0.75,0.4,$aveSHIST1314,'LRTB',0,C,true);
		...
		//scl
		$ttl_QG_scl_K13 = $ttl_QG_scl_K13 + $cSCL[$j][4];
		$ttl_QG_scl_K14 = $ttl_QG_scl_K14 + $cSCL[$j][8];
		$ttl_AVE_scl_1314 = $ttl_AVE_scl_1314 + $aveSCL1314;
		
		//shist
		$ttl_QG_shist_K13 = $ttl_QG_shist_K13 + $cSHIST[$j][4];
		$ttl_QG_shist_K14 = $ttl_QG_shist_K14 + $cSHIST[$j][8];
		$ttl_AVE_shist_1314 = $ttl_AVE_shist_1314 + $aveSHIST1314;
	...
	//scl
	$ave_QG_scl_K13 = number_format( $ttl_QG_scl_K13 / $jmlssw );
	$ave_QG_scl_K14 = number_format( $ttl_QG_scl_K14 / $jmlssw );
	$ave_QG_scl_1314 = number_format( $ttl_AVE_scl_1314 / $jmlssw ,3,',','.' );
	
	//shist
	$ave_QG_shist_K13 = number_format( $ttl_QG_shist_K13 / $jmlssw );
	$ave_QG_shist_K14 = number_format( $ttl_QG_shist_K14 / $jmlssw );
	$ave_QG_shist_1314 = number_format( $ttl_AVE_shist_1314 / $jmlssw ,3,',','.' );
	...
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_scl_K13,'LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_scl_K14,'LRTB',0,C,true);
	$pdf->SetFont('Arial','',6.5);
	$pdf->Cell( 0.75,0.4,$ave_QG_scl_1314,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_shist_K13,'LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_shist_K14,'LRTB',0,C,true);
	$pdf->SetFont('Arial','',6.5);
	$pdf->Cell( 0.75,0.4,$ave_QG_shist_1314,'LRTB',0,C,true);
...
//{
	...
	$pdf->SetFont('Arial','',7);
	$pdf->Cell( 6.75	,0.5,'COMPULSORY HISTORY','LRTB',0,C,true);
	$pdf->Cell( 6.75	,0.5,'TLE','LRTB',0,C,true);
	$pdf->Cell( 6.75	,0.5,'COMPULSORY MATHEMATICS','LRTB',0,C,true);
	...
	while($dataZ =mysql_fetch_array($resultZ))
	{
		...
		$qHIST	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='HIST' "; // menghasilkan nilai avehw hist
		...
		$qICT	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='ICT' "; // menghasilkan nilai avehw ict
		...
		$qMTH	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='MTH' "; // menghasilkan nilai avehw mth
...
//{
	...
	$pdf->Cell( 6.75	,0.5,'ENGLISH LITERATURE','LRTB',0,C,true);
	...
	while($dataZ =mysql_fetch_array($resultZ))
	{
		...
		$qPE	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='PE' "; // menghasilkan nilai avehw pe
		...
		$qENGL	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='ENGL' "; // menghasilkan nilai avehw engl
		$rENGL =mysql_query($qENGL) or die('Query gagal5');
		while($dENGL =mysql_fetch_array($rENGL))
		{
			$cENGL[$i][0]=$dENGL['avehw'."$sms"."$midtrm"];
			$cENGL[$i][1]=$dENGL['aveprj'."$sms"."$midtrm"];
			$cENGL[$i][2]=$dENGL['avetes'."$sms"."$midtrm"];
			$cENGL[$i][3]=$dENGL['avemid'."$sms"."$midtrm"];
			$cENGL[$i][4]=$dENGL['qg_k13_'."$sms"."$midtrm"]; // QG k13
			
			$cENGL[$i][5]=$dENGL['aveae'."$sms"."$midtrm"];
			$cENGL[$i][6]=$dENGL['aveaf'."$sms"."$midtrm"];
			$cENGL[$i][7]=$dENGL['aveag'."$sms"."$midtrm"];
			$cENGL[$i][8]=$dENGL['qg_k14_'."$sms"."$midtrm"]; // QG k14
		}
		...
		$qRLG	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='RLG' "; // menghasilkan nilai avehw rlg
	...
	while($j<$i AND $x<=30)
	{
		...
		//engl
		$qgENGL_k13=$cENGL[$j][4];
		$qgENGL_k14=$cENGL[$j][8];
		$aveENGL1314=($qgENGL_k13+$qgENGL_k14)/2;
		...
		//engl
		$pdf->SetFillColor(255,255,255); 
		$pdf->Cell( 0.5	,0.4,$cENGL[$j][0],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cENGL[$j][1],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cENGL[$j][2],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cENGL[$j][3],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cENGL[$j][4],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cENGL[$j][5],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cENGL[$j][6],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cENGL[$j][7],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cENGL[$j][8],'LRTB',0,C,true);
		$pdf->Cell( 0.75,0.4,$aveENGL1314,'LRTB',0,C,true);
		...
		//engl
		$ttl_QG_engl_K13 = $ttl_QG_engl_K13 + $cENGL[$j][4];
		$ttl_QG_engl_K14 = $ttl_QG_engl_K14 + $cENGL[$j][8];
		$ttl_AVE_engl_1314 = $ttl_AVE_engl_1314 + $aveENGL1314;
	...
	//engl
	$ave_QG_engl_K13 = number_format( $ttl_QG_engl_K13 / $jmlssw );
	$ave_QG_engl_K14 = number_format( $ttl_QG_engl_K14 / $jmlssw );
	$ave_QG_engl_1314 = number_format( $ttl_AVE_engl_1314 / $jmlssw ,3,',','.' );
	...
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_engl_K13,'LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_engl_K14,'LRTB',0,C,true);
	$pdf->SetFont('Arial','',6.5);
	$pdf->Cell( 0.75,0.4,$ave_QG_engl_1314,'LRTB',0,C,true);
...
//{
	...
	while($dataZ =mysql_fetch_array($resultZ))
	{
		...
		//mnd
		$qMND	 	="	SELECT 		t_prgrptps_sma_k13.*
						FROM 		t_prgrptps_sma_k13
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='MND' "; // menghasilkan nilai avehw mnd
