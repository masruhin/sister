    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04LTK()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<FORM ACTION='pendataan/R1D04LTK_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT LEARNING RECORD</B></TD></TR>
           		<TR></TR><TR></TR>
				<TR><TD WIDTH='15%'>NIS</TD>
					<TD WIDTH='85%'>:
						...
						$query2="	SELECT 		nis, nmassw
									FROM 		t_mstssw
                                    WHERE      	str != 'K' AND 
												( kdekls LIKE 'PG%' OR kdekls LIKE 'KG%' )
									ORDER BY	kdekls ";
