<?php
//----------------------------------------------------------------------------------------------------
//Program		: R1D04LSMP.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 21/12/2011
//Keterangan	: Fungsi-fungsi SISWA print ledger smp 8-9
//----------------------------------------------------------------------------------------------------
if(!defined("sister"))
{
    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04LSMP()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<FORM ACTION='pendataan/R1D04LSMP_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT MID TERM LEDGER (JHS) 9</B></TD></TR>
           		<TR></TR><TR></TR>
				<TR><TD WIDTH='15%'>Class</TD>
					<TD WIDTH='85%'>:
						...
						{
							/*if($data[kdekls]=='JHS-7A' OR $data[kdekls]=='JHS-7B' $data[kdekls]=='JHS-8A' OR $data[kdekls]=='JHS-8B' OR )
							{
								
							}
							else*/ if($data[kdekls]=='JHS-9A' OR $data[kdekls]=='JHS-9B')
							{
