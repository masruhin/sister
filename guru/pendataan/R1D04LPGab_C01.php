...
$qLGKG	="	SELECT 		 t_learnrcd_tk_akr.*
			...
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='PG1' OR t_learnrcd_tk_akr.kdekls='PG2' ) AND t_learnrcd_tk_akr.kdeplj='APG-A' ";
...
$qLGKG2	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='PG1' OR t_learnrcd_tk_akr.kdekls='PG2' ) AND t_learnrcd_tk_akr.kdeplj='APG-B' ";
...
$qLGKG3	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='PG1' OR t_learnrcd_tk_akr.kdekls='PG2' ) AND t_learnrcd_tk_akr.kdeplj='APG-C' ";
...
$qLGKG4	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='PG1' OR t_learnrcd_tk_akr.kdekls='PG2' ) AND t_learnrcd_tk_akr.kdeplj='APG-D' ";
...
$qLGKG5	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='PG1' OR t_learnrcd_tk_akr.kdekls='PG2' ) AND t_learnrcd_tk_akr.kdeplj='APG-E' ";
...
//{
	...
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, "KELOMPOK        : KB", '', 0, L, true);
