	...
	function R1D04X()
	{
		...
		while($data = mysql_fetch_array($result)) // .. d
		{
			...
			//{
				...
				//$cell[$i][$y+9]=$data2['st'."$sms"."$nlitrm"]; // ST hw				
				...
				//$cell[$i][$y+18]=$data2['st_'."$sms"."$nlitrm"]; // ST prj
				...
				//{
					echo"<TR bgcolor='dedede'>
						...
						/*if ($pilihan=='detil'  AND $kdekls!='')
							echo"
							<TD WIDTH='4%' ROWSPAN='2'><CENTER><a href='guru.php?mode=R1D04X&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=st'><span style='color: #FF0000;'><b>st</b></span></CENTER></TD>";
						else
							echo"
							<TD WIDTH='4%' ROWSPAN='2'><CENTER>st</CENTER></TD>";*/
							
					echo"<TD WIDTH='25%' COLSPAN='8'><CENTER>Skills Assessments (SA)	    	</CENTER></TD>";
					
						/*if ($pilihan=='detil'  AND $kdekls!='')
							echo"
							<TD WIDTH='4%' ROWSPAN='2'><CENTER><a href='guru.php?mode=R1D04X&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=st_'><span style='color: #FF0000;'><b>st</b></span></CENTER></TD>";
						else
							echo"
							<TD WIDTH='4%' ROWSPAN='2'><CENTER>st</CENTER></TD>";*/
