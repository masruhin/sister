...
//{
	...
	while($dataY =mysql_fetch_array($resultY))
	{
		...
		$qBLGY	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='BLGY' "; // menghasilkan nilai avehw blgy
...
//{
	...
	$pdf->SetFont('Arial','',7);
	$pdf->Cell( 6.75	,0.5,'PHYSICS','LRTB',0,C,true);
	$pdf->Cell( 6.75	,0.5,'CHEMISTRY','LRTB',0,C,true);
	$pdf->Cell( 6.75	,0.5,'SUPMATH','LRTB',0,C,true);
	...
	while($dataZ =mysql_fetch_array($resultZ))
	{
		...
		$qPHY	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='PHY' "; // menghasilkan nilai avehw phy
		...
		$qCHM	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='CHM' "; // menghasilkan nilai avehw chm
		...
		while($dCHM =mysql_fetch_array($rCHM))
		{
			...
			$cCHM[$i][2]=$dCHM['avetes'."$sms"."$midtrm"];
			$cCHM[$i][3]=$dCHM['avemid'."$sms"."$midtrm"];
			$cCHM[$i][4]=$dCHM['qg_k13_'."$sms"."$midtrm"]; // QG k13
			
			$cCHM[$i][5]=$dCHM['aveae'."$sms"."$midtrm"];
			$cCHM[$i][6]=$dCHM['aveaf'."$sms"."$midtrm"];
			$cCHM[$i][7]=$dCHM['aveag'."$sms"."$midtrm"];
			$cCHM[$i][8]=$dCHM['qg_k14_'."$sms"."$midtrm"]; // QG k14
		}
		...
		$qSMTH	 	="	SELECT 		t_prgrptps_sma_k13.*
						...
						WHERE 		t_prgrptps_sma_k13.nis='". mysql_escape_string($nis)."'	AND
									t_prgrptps_sma_k13.thn_ajaran='". mysql_escape_string($thn_ajr)."'	AND
									t_prgrptps_sma_k13.kdeplj='SMTH' "; // menghasilkan nilai avehw smth
		$rSMTH =mysql_query($qSMTH) or die('Query gagal5');
		while($dSMTH =mysql_fetch_array($rSMTH))
		{
			$cSMTH[$i][0]=$dSMTH['avehw'."$sms"."$midtrm"];
			$cSMTH[$i][1]=$dSMTH['aveprj'."$sms"."$midtrm"];
			$cSMTH[$i][2]=$dSMTH['avetes'."$sms"."$midtrm"];
			$cSMTH[$i][3]=$dSMTH['avemid'."$sms"."$midtrm"];
			$cSMTH[$i][4]=$dSMTH['qg_k13_'."$sms"."$midtrm"]; // QG k13
			
			$cSMTH[$i][5]=$dSMTH['aveae'."$sms"."$midtrm"];
			$cSMTH[$i][6]=$dSMTH['aveaf'."$sms"."$midtrm"];
			$cSMTH[$i][7]=$dSMTH['aveag'."$sms"."$midtrm"];
			$cSMTH[$i][8]=$dSMTH['qg_k14_'."$sms"."$midtrm"]; // QG k14
		}
	...
	while($j<$i AND $x<=30)
	{
		...
		$qgCHM_k13=$cCHM[$j][4];
		$qgCHM_k14=$cCHM[$j][8];
		$aveCHM1314=($qgCHM_k13+$qgCHM_k14)/2;
		
		//smth
		$qgSMTH_k13=$cSMTH[$j][4];
		$qgSMTH_k14=$cSMTH[$j][8];
		$aveSMTH1314=($qgSMTH_k13+$qgSMTH_k14)/2;
		...
		//chm
		$pdf->SetFillColor(255,255,255); 
		$pdf->Cell( 0.5	,0.4,$cCHM[$j][0],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cCHM[$j][1],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cCHM[$j][2],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cCHM[$j][3],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cCHM[$j][4],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cCHM[$j][5],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cCHM[$j][6],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cCHM[$j][7],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cCHM[$j][8],'LRTB',0,C,true);
		$pdf->Cell( 0.75,0.4,$aveCHM1314,'LRTB',0,C,true);
		
		//smth
		$pdf->SetFillColor(255,255,255); 
		$pdf->Cell( 0.5	,0.4,$cSMTH[$j][0],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSMTH[$j][1],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSMTH[$j][2],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSMTH[$j][3],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSMTH[$j][4],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSMTH[$j][5],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSMTH[$j][6],'LRTB',0,C,true);
		$pdf->Cell( 0.5	,0.4,$cSMTH[$j][7],'LRTB',0,C,true);
		$pdf->Cell( 1	,0.4,$cSMTH[$j][8],'LRTB',0,C,true);
		$pdf->Cell( 0.75,0.4,$aveSMTH1314,'LRTB',0,C,true);
		...
		//chm
		$ttl_QG_chm_K13 = $ttl_QG_chm_K13 + $cCHM[$j][4];
		$ttl_QG_chm_K14 = $ttl_QG_chm_K14 + $cCHM[$j][8];
		$ttl_AVE_chm_1314 = $ttl_AVE_chm_1314 + $aveCHM1314;
		
		//smth
		$ttl_QG_smth_K13 = $ttl_QG_smth_K13 + $cSMTH[$j][4];
		$ttl_QG_smth_K14 = $ttl_QG_smth_K14 + $cSMTH[$j][8];
		$ttl_AVE_smth_1314 = $ttl_AVE_smth_1314 + $aveSMTH1314;
	...
	//chm
	$ave_QG_chm_K13 = number_format( $ttl_QG_chm_K13 / $jmlssw );
	$ave_QG_chm_K14 = number_format( $ttl_QG_chm_K14 / $jmlssw );
	$ave_QG_chm_1314 = number_format( $ttl_AVE_chm_1314 / $jmlssw ,3,',','.' );
	
	//smth
	$ave_QG_smth_K13 = number_format( $ttl_QG_smth_K13 / $jmlssw );
	$ave_QG_smth_K14 = number_format( $ttl_QG_smth_K14 / $jmlssw );
	$ave_QG_smth_1314 = number_format( $ttl_AVE_smth_1314 / $jmlssw ,3,',','.' );
	...
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_chm_K13,'LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_chm_K14,'LRTB',0,C,true);
	$pdf->SetFont('Arial','',6.5);
	$pdf->Cell( 0.75,0.4,$ave_QG_chm_1314,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_smth_K13,'LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 0.5	,0.4,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,$ave_QG_smth_K14,'LRTB',0,C,true);
	$pdf->SetFont('Arial','',6.5);
	$pdf->Cell( 0.75,0.4,$ave_QG_smth_1314,'LRTB',0,C,true);
