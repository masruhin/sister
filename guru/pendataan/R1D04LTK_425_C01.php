...
//{
	...
	$pdf->Cell(1.25	, 1, '', '', 0, C, false);
	$pdf->Cell(2.25	, 1, '', '', 0, C, false);
	$pdf->Cell(1.25	, 1, '', '', 0, C, false);																							$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,405,81), 'LRB', 0, J, true);
	//6
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "There are four terms in the whole academic year in which we", '', 0, J, true);								
