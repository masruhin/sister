<?php
//----------------------------------------------------------------------------------------------------
//Program		: R1D04PSMA.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 21/12/2011
//Keterangan	: Fungsi-fungsi SISWA print rapot sma 11 ipa
//----------------------------------------------------------------------------------------------------
if(!defined("sister"))
{
    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04PSMA()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<FORM ACTION='pendataan/R1D04PSMA_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
				...
				<TR><TD WIDTH='15%'>Class</TD>
					<TD WIDTH='85%'>:
						...
						{
							/*if($data[kdekls]=='SHS-10IPA' OR $data[kdekls]=='SHS-10IPS' OR $data[kdekls]=='SHS-11IPS' OR $data[kdekls]=='SHS-12IPA' OR $data[kdekls]=='SHS-12IPS')
							{
								
							}
							else*/ if($data[kdekls]=='SHS-11IPA')
							{
