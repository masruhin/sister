    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	...
 	{   
		...
		//-----Validasi kelas----//
           ...
           <SCRIPT TYPE='text/javascript' src='../guru/js/R1D04R.js'></SCRIPT>
		";
		//----End Validasi Kelas---//
		...
		<!--<FORM ID='validasi' ACTION='pendataan/R1D04R_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>-->
		<FORM ID='validasi' ACTION='pendataan/R1D04R_C01_HTML.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT GRADING SHEET (PS)</B></TD></TR>
           		<TR></TR><TR></TR>
				<TR><TD WIDTH='15%'>Subject</TD>
					...
					if(($kdejbt<300 OR $kdejbt==900) AND $kdejbt!=500)
					{
						$query2="	SELECT 	DISTINCT t_mstplj.kdeplj,t_mstplj.nmaplj
									...
									WHERE 	t_mstpng.kdeplj=t_mstplj.kdeplj AND 
											t_mstplj.str != 'X'
