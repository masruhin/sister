...
//{
	...
	$pdf->Cell(3, 1, "", '', 0, C, true);																								$pdf->Cell( 2	,0.4,'','',0,C,false);										$pdf->SetFont('Arial','B',11);	$pdf->Cell( 12.7	,0.5,'','',0,C,false);	$pdf->Cell(3, 0.5, 'THIRD TERM', '', 0, C, true);					
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "for expectations of children's achievements throughout the", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,324,81), 'LRB', 0, J, true);
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "There are four terms in the whole academic year in which we", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN3,0,81), 'LRT', 0, J, true);	
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q3KMN3,81,81), 'LR', 0, J, true);
	//7
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "competencies expected of him or her. The first term is the entry", '', 0, J, true);							$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,162,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,243,81), 'LR', 0, J, true);
	
	
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7, 0.5, "knowledge and the initial experiences in school. The second and", '', 0, L, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,324,81), 'LRB', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN4,0,81), 'LRT', 0, J, true);	
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "performance is described based on the extent of achievement", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q3KMN4,81,81), 'LR', 0, J, true);
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "or progress made as expected of him or her at the end of the", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q3KMN4,162,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN4,243,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q3KMN4,324,81), 'LRB', 0, J, true);	
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "development of your child throughout the year.", '', 0, J, true);											$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN5,0,81), 'LRT', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);				$pdf->Cell(11.5, 0.5, substr($q3KMN5,81,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN5,162,81), 'LR', 0, J, true);						
	//15
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5,"", '', 0, J, true);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN5,243,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1.5, '', '', 0, C, true);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN5,324,81), 'LRB', 0, J, true);						
	//16
	$pdf->Ln(0.5);
	...
	$pdf->SetFont('Arial','',9);
	$pdf->Cell( 1	,0.4,'','',0,C,true);
	$pdf->Cell(11.5, 0.5, substr($q2KMN2,486,81), 'LRB', 0, L, true);												$pdf->SetFont('Arial','BI',12);	$pdf->Cell( 3	,0.5,'','',0,C,false);	$pdf->Cell(2, 0.5, "Virtus et Vita (Knowledge, Virtues and Life) within the framework", '', 0, J, false);//
	
	
	
	//
	$pdf->Ln(0.5);																									$pdf->SetFont('Arial','BI',12);	$pdf->Cell( 15.5	,0.5,'','',0,C,false);		$pdf->Cell(2, 0.5, "of Christian values.", '', 0, J, false);//
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BU',11);
	...
	$pdf->Cell(1.25	, 1, $q3nli[1][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q1KMN,0,81), 'LRT', 0, J, true);
	//1
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[0][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN,81,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[2][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q1KMN,162,81), 'LR', 0, J, true);
	//2
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[1][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN,243,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1.5, $q3nli[3][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q1KMN,324,81), 'LRB', 0, J, true);	
	//3
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->SetFont('Arial','BU',10);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.5, 0.5, "B. Self-care and independence", 'LRT', 0, L, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);			$pdf->SetFillColor(255,255,255);				$pdf->Cell(11.5, 0.5, substr($q1KMN2,0,81), 'LRT', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[4][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q1KMN2,81,81), 'LR', 0, J, true);
	//4
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[3][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN2,162,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[4][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q1KMN2,243,81), 'LR', 0, J, true);	
	...
	$pdf->SetFont('Arial','BU',10);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.5, 0.5, "C. Confidence and Self-esteem", 'LRT', 0, L, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q1KMN2,324,81), 'LRB', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[7][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q1KMN3,0,81), 'LRT', 0, J, true);
	//7
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[6][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q1KMN3,81,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[8][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,162,81), 'LR', 0, J, true);
	//8
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[7][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,243,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[9][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,324,81), 'LRB', 0, J, true);
	//9
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[10][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN4,0,81), 'LRT', 0, J, true);
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[9][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q1KMN4,81,81), 'LR', 0, J, true);	
	...
	$pdf->Cell(1.25	, 1, $q3nli[11][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN4,162,81), 'LR', 0, J, true);
	//11
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[10][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q1KMN4,243,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[12][0], 'LRTB', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q1KMN4,324,81), 'LRB', 0, J, true);
	...
	$pdf->Ln(0.5);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, false);
	$pdf->Cell(7	, 0.5, '', '', 0, J, false);												$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN5,0,81), 'LRT', 0, J, true);
	
	$pdf->Ln(0.5);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, false);
	$pdf->Cell(7	, 0.5, '', '', 0, J, false);												$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);				$pdf->Cell(11.5, 0.5, substr($q1KMN5,81,81), 'LR', 0, J, true);
	
	$pdf->Ln(0.5);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, false);
	$pdf->Cell(7	, 0.5, '', '', 0, J, false);												$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN5,162,81), 'LR', 0, J, true);						
	...
	$pdf->Cell(1.25	, 0.8, $q3nliB[1][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);					$pdf->SetFillColor(255,255,255);							$pdf->Cell(0.5	, 0.4, "1", 'LT', 0, C, true);									$pdf->Cell(7	, 0.4, substr( $nmektr3[0][0] ,0,53 ), 'RT', 0, J, true);								$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.8, $q1nliC[1][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.8, $q2nliC[1][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.8, $smstr1C[1][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.8, $q3nliC[1][0], 'LRT', 0, C, true);
	//1
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[0][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[0][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.8, $q3nliB[2][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "2", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[1][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.8, $q1nliC[2][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.8, $q2nliC[2][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.8, $smstr1C[2][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.8, $q3nliC[2][0], 'LRT', 0, C, true);
	//2
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[1][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[1][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.8, $q3nliB[3][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "3", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[2][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.8, $q1nliC[3][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.8, $q2nliC[3][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.8, $smstr1C[3][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.8, $q3nliC[3][0], 'LRT', 0, C, true);
	//3
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[2][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[2][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.8, $q3nliB[4][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "4", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[3][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.8, $q1nliC[4][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.8, $q2nliC[4][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.8, $smstr1C[4][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.8, $q3nliC[4][0], 'LRT', 0, C, true);
	//4
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[3][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[3][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(1.25	, 1.2, $q3nliB[5][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "5", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[4][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.4, $q1nliC[5][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.4, $q2nliC[5][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.4, $smstr1C[5][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.4, $q3nliC[5][0], 'LRT', 0, C, true);
	//5
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[4][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "6", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[5][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.8, $q1nliC[6][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.8, $q2nliC[6][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.8, $smstr1C[6][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.8, $q3nliC[6][0], 'LRT', 0, C, true);
	//5
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[4][0] ,106,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[5][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.8, $q3nliB[6][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);					$pdf->SetFillColor(255,255,255);							$pdf->Cell(0.5	, 0.4, "7", 'LT', 0, C, true);									$pdf->Cell(7	, 0.4, substr( $nmektr3[6][0] ,0,53 ), 'RT', 0, J, true);								$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.4, $q1nliC[7][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.4, $q2nliC[7][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.4, $smstr1C[7][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.4, $q3nliC[7][0], 'LRT', 0, C, true);
	//6
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[5][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "8", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[7][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.4, $q1nliC[8][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.4, $q2nliC[8][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.4, $smstr1C[8][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.4, $q3nliC[8][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(1.25	, 1.2, $q3nliB[7][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "9", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[8][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.8, $q1nliC[9][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.8, $q2nliC[9][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.8, $smstr1C[9][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.8, $q3nliC[9][0], 'LRT', 0, C, true);
	//7
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[6][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[8][0] ,53,53 ), 'R', 0, J, true);
	//7
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[6][0] ,106,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "10", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[9][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 1.2, $q1nliC[10][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 1.2, $q2nliC[10][0], 'LRT', 0, C, true);		$pdf->Cell(2.25	, 1.2, $smstr1C[10][0], 'LRT', 0, C, true);	$pdf->Cell(1.25	, 1.2, $q3nliC[10][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(1.25	, 0.8, $q3nliB[8][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);				$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[9][0] ,53,53 ), 'R', 0, J, true);
	//8
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[7][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[9][0] ,106,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(1.25	, 1.2, $q3nliB[9][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 2	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "11", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[10][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.8, $q1nliC[11][0], 'LRTB', 0, C, true);		$pdf->Cell(1.25	, 0.8, $q2nliC[11][0], 'LRTB', 0, C, true);		$pdf->Cell(2.25	, 0.8, $smstr1C[11][0], 'LRTB', 0, C, true);	$pdf->Cell(1.25	, 0.8, $q3nliC[11][0], 'LRTB', 0, C, true);
	//9
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[8][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'LB', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[10][0] ,53,53 ), 'RB', 0, J, true);
	//9
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	...
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.4, "", 'LB', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr4[9][0] ,53,53 ), 'RB', 0, J, true);					$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);				$pdf->SetFillColor(255,255,255);								$pdf->Cell(0.5	, 0.4, "14", 'LT', 0, C, true);									$pdf->Cell(7	, 0.4, substr( $nmektr5[13][0] ,0,53 ), 'RT', 0, J, true);		$pdf->SetFont('Arial','',11);						$pdf->Cell(1.25	, 0.4, $q1nliE[14][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.4, $q2nliE[14][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.4, $smstr1E[14][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.4, $q3nliE[14][0], 'LRT', 0, C, true);
	
	$pdf->Ln(0.4);
	$pdf->Cell(0.5	, 0.4, "", '', 0, C, false);
	$pdf->Cell(7	, 0.4, '', '', 0, J, false);												$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);				$pdf->SetFillColor(255,255,255);								$pdf->Cell(0.5	, 0.4, "15", 'LT', 0, C, true);									$pdf->Cell(7	, 0.4, substr( $nmektr5[14][0] ,0,53 ), 'RT', 0, J, true);		$pdf->SetFont('Arial','',11);						$pdf->Cell(1.25	, 0.4, $q1nliE[15][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.4, $q2nliE[15][0], 'LRT', 0, C, true);	$pdf->Cell(2.25	, 0.4, $smstr1E[15][0], 'LRT', 0, C, true);			$pdf->Cell(1.25	, 0.4, $q3nliE[15][0], 'LRT', 0, C, true);
