...
//Keterangan	: Fungsi-fungsi INPUT PROGRESS REPORT smp
//----------------------------------------------------------------------------------------------------
if(!defined("sister"))
{
...
class R1D04Yclass
{
	...
	function R1D04Y()
	{
		...
		while($data = mysql_fetch_array($result))
		{
			...
			while($y<6)
			{
				$cell[$i][$y+21]=$data2['ag'."$sms"."$nlitrm"."$y"];
				$y++;
			}*/
			...
			<DIV style='overflow:auto;;width:100%;height:340px;padding-right:-2px;'>
				<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='0' WIDTH='100%' class='table02'>
					<TR bgcolor='dedede'>
						...
						<TD WIDTH='25%' COLSPAN='5' HEIGHT='20'><CENTER>QUIZZES/PERFORMANCE	    	</CENTER></TD>
						<TD WIDTH='25%' COLSPAN='5'><CENTER>ORAL / PROJECT/HOMEWORK/PRACTICE	    	</CENTER></TD>
						<TD WIDTH='24%' COLSPAN='5'><CENTER>UNIT TEST	    	</CENTER></TD>";
						if ($pilihan=='detil'  AND $kdekls!='')
							echo"
							<TD WIDTH='4%' ROWSPAN='2'><CENTER><a href='guru.php?mode=R1D04Y&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=midtes'><span style='color: #FF0000;'><b>mid</b></span></CENTER></TD>";
						else
							echo"
							<TD WIDTH='4%' ROWSPAN='2'><CENTER>mid</CENTER></TD>";
						
						//echo"<TD WIDTH='24%' COLSPAN='5'><CENTER>AFFECTIVE GRADE							    	</CENTER></TD>";
					...
					<TR bgcolor='dedede'>";
						if ($pilihan=='detil'  AND $kdekls!='')
						{
							...
							while($y<6)
							{
								echo"<TD WIDTH='4%' HEIGHT='20'><CENTER><a href='guru.php?mode=R1D04Y&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=hw&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}	
							$y=1;
							while($y<6)
							{
								echo"<TD WIDTH='4%'><CENTER><a href='guru.php?mode=R1D04Y&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=prj&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}	
							$y=1;
							while($y<6)
							{
								echo"<TD WIDTH='4%'><CENTER><a href='guru.php?mode=R1D04Y&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=tes&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}
							/*
							$y=1;
							while($y<6)
							{
								echo"<TD WIDTH='4%'><CENTER><a href='guru.php?mode=R1D04Y&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=ag&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}
							*/
						}
	...
	function R1D04Y_Save()
	{
		...
		while($j<$i)
		{
			...
			$set	="	SET		t_prgrptps_smp."."$akh"."	='". mysql_escape_string($nliakh)."'"; 
			$query 	="	UPDATE 	t_prgrptps_smp ".$set.
					"	WHERE 	t_prgrptps_smp.nis	='". mysql_escape_string($nis)	."'	AND
								t_prgrptps_smp.kdeplj	='". mysql_escape_string($kdeplj)	."'";
			$result =mysql_query ($query) or die (error("Data tidak berhasil di rubah"));		
		...
		echo"<meta http-equiv='refresh' content=\"0;url=guru.php?mode=R1D04Y&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=detil\">\n";
 	}		
}//akhir class
?>