...
class R1D02Eclass
{
	...
	function R1D02E()
	{
		...
		echo"<SCRIPT TYPE='text/javascript' 		src='../guru/js/R1D02E.js'></SCRIPT>";
		...
		<FORM METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
						...
						<div style='overflow:auto;width:100%;height:390px;padding-right:-2px;'>
							<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='0' CELLSPACING='0' WIDTH='100%' class='table02'>
								<TR bgcolor='dedede'>
									...
									<TD WIDTH='73%'><CENTER>Teacher		</CENTER></TD>
									...
									<TD WIDTH='20%'><CENTER>Lesson Plan				</CENTER></TD>
								</TR>";//Task
			                   ...
			                   <a href='#'  id='$kdekry' class='rpp'>
                                ...
                                $querykls="	SELECT *,t_mstkry.nmakry
										...
										WHERE 	t_prstkt.kdetkt='". mysql_escape_string($kdetkt)."'AND
												...
												substr(t_mstkry.kdestt,1,1)	='G' AND
			...
			<INPUT TYPE='button' VALUE='Statistic' 	onClick=window.open('pendataan/R1D02E_C01.php')>
		</FORM>";
	}
}//akhir class
?>