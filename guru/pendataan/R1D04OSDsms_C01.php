...
if($sms=='2')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04OSDsms2_C01.php?kdekls=$kdekls&thnajr=$thnajr\">\n";
...
//{
	...
	$pdf->Ln();
	$pdf->Cell( 1.5	,0.4,"",0,0,L);
	$pdf->Cell(17.5	,0.6, "FIRST SEMESTER CLASS PERFORMANCE",0,0,C); // 19 $judul2 
