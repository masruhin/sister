...
<CAPTION>
	<B>STATUS CONSELING</B><br/><br/>
</CAPTION>";

echo"
	<THEAD>
	<TR>
		<TH rowspan='2' align='center' width='5%'>	No.	</TH><TH rowspan='2' align='center' width='10%'>	Hari / Tanggal	</TH><TH rowspan='2' align='center'>	Hasil Konseling	</TH><TH rowspan='2' align='center'>	Catatan	</TH><TH rowspan='2' align='center' width='15%'>	Tanda Tangan Penyuluh	</TH>
	</TR>
	</THEAD>
";
...
while($n<$m)
{
	...
	echo"
		<TR>
			<TD>	$no	</TD><TD>	$tgl	</TD><TD align='justify'>	$peny	</TD><TD>		</TD><TD>		</TD>
		</TR>
	";
	$n++;
	$no++;
