    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D11B()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<!--<FORM ACTION='pendataan/R1D11B_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>-->
		<FORM ACTION='pendataan/R1D11B_C01_HTML.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>CETAK RAPOR DIKNAS (SD) COVER 2</B></TD></TR>
           		<TR></TR><TR></TR>
