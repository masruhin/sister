...
// -------------------------------------------------- Class --------------------------------------------------
class R1D04LSDfnlclass
{
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04LSDfnl()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<!--<FORM ACTION='pendataan/R1D04LSDfnl_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>-->
		<FORM ACTION='pendataan/R1D04LSDfnl_C01_HTML.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT FINAL SEMESTER LEDGER (PS)</B></TD></TR>
           		<TR></TR><TR></TR>
