...
//{
	...
	while($i<26)
	{
		...
		else if( ($q1nliB[$i][0]=='v'OR$q1nliB[$i][0]=='V') AND $q2nliB[$i][0]=='+' ) // v +
			$smstr1B[$i][0] = 'S';
		else if( $q1nliB[$i][0]=='NO' AND ($q2nliB[$i][0]=='v'OR$q2nliB[$i][0]=='V') ) // NO v
			$smstr1B[$i][0] = 'VS';
	...
	while($i<26)
	{
		...
		else if( ($q1nliC[$i][0]=='v'OR$q1nliC[$i][0]=='V') AND $q2nliC[$i][0]=='+' ) // v +
			$smstr1C[$i][0] = 'S';
		else if( $q1nliC[$i][0]=='NO' AND ($q2nliC[$i][0]=='v'OR$q2nliC[$i][0]=='V') ) // NO v
			$smstr1C[$i][0] = 'VS';
		
		else if( $q1nliC[$i][0]=='ND' AND $q2nliC[$i][0]=='+' ) // ND +
			$smstr1C[$i][0] = 'S';
	...
	while($i<26)
	{
		...
		else if( ($q1nliF[$i][0]=='v'OR$q1nliF[$i][0]=='V') AND $q2nliF[$i][0]=='+' ) // v +
			$smstr1F[$i][0] = 'S';
		else if( $q1nliF[$i][0]=='NO' AND ($q2nliF[$i][0]=='v'OR$q2nliF[$i][0]=='V') ) // NO v
			$smstr1F[$i][0] = 'VS';
		
		else if( $q1nliF[$i][0]=='ND' AND $q2nliF[$i][0]=='+' ) // ND +
			$smstr1F[$i][0] = 'S';
		else if( $q1nliF[$i][0]=='NO' AND $q2nliF[$i][0]=='/' ) // NO /
			$smstr1F[$i][0] = 'MS';
