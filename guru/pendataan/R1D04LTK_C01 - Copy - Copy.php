...
//{
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.5	,0.4,'','',0,C,true);
	$pdf->Cell(10, 0.75, "", 'LR', 0, C, true);														$pdf->SetFont('Arial','',11);	$pdf->Cell( 5	,0.5,'','',0,C,false);	$pdf->Cell(3, 1, " Class", 'L', 0, L, true);				$pdf->Cell(0.5, 1, " : ", '', 0, L, true);	$pdf->SetFont('Arial','U',11);	$pdf->Cell(7.5, 1, $kkelas, 'R', 0, L, true);//nis
	//4
	$pdf->Ln(0.75);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.5	,0.4,'','',0,C,false);
	$pdf->Cell(10, 0.75, "", 'LR', 0, C, false);													$pdf->SetFont('Arial','',11);	$pdf->Cell( 5	,0.5,'','',0,C,false);	$pdf->Cell(3, 1, " Place of Birth", 'L', 0, L, true);		$pdf->Cell(0.5, 1, " : ", '', 0, L, true);	$pdf->SetFont('Arial','U',11);	$pdf->Cell(7.5, 1, $tmplhr, 'R', 0, L, true);
	//5
	$pdf->Ln(0.75);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.5	,0.4,'','',0,C,true);
	$pdf->Cell(10, 0.75, "", 'LRB', 0, C, true);													$pdf->SetFont('Arial','',11);	$pdf->Cell( 5	,0.5,'','',0,C,false);	$pdf->Cell(3, 1, " Date of Birth", 'L', 0, L, true);		$pdf->Cell(0.5, 1, " : ", '', 0, L, true);	$pdf->SetFont('Arial','U',11);	$pdf->Cell(7.5, 1, $tgllhr, 'R', 0, L, true);//nis
	...
	$pdf->SetFont('Arial','BU',11);
	//$pdf->Cell( 1	,0.4,'','',0,C,true);
	$pdf->Cell(1, 0.75, "3. Mathematical/Cognitive Development", '', 0, L, true);					$pdf->SetFont('Arial','',11);	$pdf->Cell( 15.5	,0.5,'','',0,C,false);	$pdf->Cell(3, 1, " Mother's Name", 'L', 0, L, true);		$pdf->Cell(0.5, 1, " : ", '', 0, L, true);	$pdf->SetFont('Arial','U',11);	$pdf->Cell(7.5, 1, $nmaibu, 'R', 0, L, true);//nis
	//1
	$pdf->Ln(0.75);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.5	,0.4,'','',0,C,true);
	$pdf->Cell(10, 0.75, "", 'LRT', 0, C, true);													$pdf->SetFont('Arial','',11);	$pdf->Cell( 5	,0.5,'','',0,C,false);	$pdf->Cell(3, 1, " Father's Name", 'L', 0, L, true);		$pdf->Cell(0.5, 1, " : ", '', 0, L, true);	$pdf->SetFont('Arial','U',11);	$pdf->Cell(7.5, 1, $nmaayh, 'R', 0, L, true);//nis
	//2
	$pdf->Ln(0.75);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.5	,0.4,'','',0,C,true);
	...
	$pdf->Image($signature, 18, 14.3, 5, 4);
	$pdf->Ln(0.75);
	$pdf->SetFont('Arial','BU',11);
	//$pdf->Cell( 1	,0.4,'','',0,C,true);
	...
	$pdf->Cell( 5	,0.4,'','',0,C,true);
	$pdf->Cell(2.5, 1, "Personal, Social and Emotional Development", '', 0, C, true);
