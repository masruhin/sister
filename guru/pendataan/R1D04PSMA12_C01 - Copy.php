...
if($sms=='1' AND $midtrm=='2')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04PSMA12_C01_2.php?kdekls=$kdekls&thn_ajr=$thn_ajr\">\n";
if($sms=='2' AND $midtrm=='1')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04PSMA12_C01_3.php?kdekls=$kdekls&thn_ajr=$thn_ajr\">\n";
...
while($y<$x)
{
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2RLG
	$pdf->Cell( 0.75	,0.5,$akh1RLG,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$ahw2CME
	$pdf->Cell( 0.75	,0.5,$akh1CME,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2BIN
	$pdf->Cell( 0.75	,0.5,$akh1BIN,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$ahw2MTH
	$pdf->Cell( 0.75	,0.5,$akh1MTH,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2BLGY
	$pdf->Cell( 0.75	,0.5,$akh1BLGY,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2CHM
	$pdf->Cell( 0.75	,0.5,$akh1CHM,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2PHY
	$pdf->Cell( 0.75	,0.5,$akh1PHY,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$ahw2HIST
	$pdf->Cell( 0.75	,0.5,$akh1HIST,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$ahw2ART
	$pdf->Cell( 0.75	,0.5,$akh1ART,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2PE
	$pdf->Cell( 0.75	,0.5,$akh1PE,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2ICT
	$pdf->Cell( 0.75	,0.5,$akh1ICT,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2FOR
	$pdf->Cell( 0.75	,0.5,$akh1FOR,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.4,$ktr1a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr2a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr3a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr4a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr5a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr6a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q1ATT		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q1DIL		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q1ORD		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q1CLE		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
