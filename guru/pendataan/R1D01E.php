...
class R1D01Eclass
{
		...
		<BODY onload='sf();'>
			...
			<FORM ID='validasi'  ACTION='guru.php'METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
				<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
					<TR><TD COLSPAN='2'><B><!--UPLOAD WORKSHEET-->ASSESSMENT</B></TD></TR>
					<TR></TR><TR></TR>
				...
				<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
							...
							<div style='overflow:auto;width:100%;height:330px;padding-right:-2px;'>                
								<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='0' CELLSPACING='0' WIDTH='100%' class='table02'>
									<TR bgcolor='dedede'>
										...
										<TD WIDTH='35%'><CENTER>Title  		</CENTER></TD>
                                        <TD WIDTH='30%'><CENTER>Teacher  	</CENTER></TD>
									...
									<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='0' CELLSPACING='0' WIDTH='100%' id='tugas' class='table02'>
									</TABLE>
											...
											{   $id=$data['id'];
												...
												<TR onMouseOver=\"this.className='highlight'\" onMouseOut=\"this.className='normal'\">
													...
													if ($pilihan=='detil_general' or $pilihan=='tambah_item')
													{
                                                        ...
                                                        echo"
														<TD WIDTH='7%'><CENTER><a href='../files/materi/$kdetgs/$nmatgs2.$type'target='_blank'><IMG src='../images/detil_e.gif' BORDER='0'></a></CENTER></TD>";
                                                        if($kdegru!=$user)
                                                        {
                                                          echo"
                                                        ...
                                                        {
                                                        echo"
														<TD WIDTH='7%'><CENTER><a href='#' id='$data[id]'typ='$type' nmatg='$nmatgs2'class='hapustgs'><IMG src='../images/hapus_e.gif' BORDER='0'></a></CENTER></TD>";
                                                        }
													}
													else
													{
					...
					<TR>
						<TD ALIGN='left'>
							<INPUT TYPE='button' VALUE='New' onClick=window.location.href='guru.php?mode=R1D01E&pilihan=tambah_general'>";
							...
							{
								echo"
								<INPUT TYPE='button' VALUE='Print' 	onClick=window.open('pendataan/R1D01E_Cetak.php?kdetgs=$kdetgs')>";
							}
						echo"
						</TD>
					</TR>
	...
	function R1D01E_Save_Item()
	{
        ...
        $handle = is_dir("../files/materi/$kdetgs");
        if($handle=='')
        {
			mkdir("../files/materi/".$kdetgs, 0775);
        }
		...
		{
			$newfile= "../files/materi/$kdetgs/$tgs.$type[1]";
			if (file_exists($newfile))
				unlink($newfile);
			copy($pdf, "../files/materi/$kdetgs/$tgs.$type[1]");
		}
