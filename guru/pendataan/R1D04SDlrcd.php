    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04SDlrcd()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<FORM ACTION='pendataan/R1D04SDlrcd_C01_HTML.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT LEARNING RECORD (PS)</B></TD></TR>
           		<TR></TR><TR></TR>
