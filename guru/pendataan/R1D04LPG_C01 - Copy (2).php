...
//{
	...
	if( strlen($almt)>37 )
	{
		...
		//$pdf->Ln(0.5);
		//$pdf->SetFont('Arial','',11);	$pdf->Cell( 15.5	,0.5,'','',0,C,false);	$pdf->Cell(3, 0.5, "", 'L', 0, L, true);				$pdf->Cell(0.5, 0.5, "  ", '', 0, L, true);	$pdf->SetFont('Arial','U',11);	$pdf->Cell(10, 0.5, substr($almt,37,37), 'R', 0, C, true);//nis
	...
	while($i<26)
	{
		...
		/*if( $q1nli[$i][0] == 'v' OR $q1nli[$i][0] == 'V' )
			$q1nli[$i][0] = '√';//'&radic;';//"U+2713";//
		if( $q2nli[$i][0] == 'v' OR $q2nli[$i][0] == 'V' )
			$q2nli[$i][0] = '√';//'&radic;';//'U+2713';*/
