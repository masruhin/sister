...
while($y<$x)
{
	...
	$pdf->Cell( 9	,0.5,'Regularly attends and actively participates in school activities and ','LRT',0,J,true);
	
	$pdf->Ln();
	$pdf->Cell( 1.5	,0.4,'',0,0,L);
	$pdf->Cell( 0.6	,1,'',0,0,C,false);
	$pdf->Cell( 5.2	,1,'',0,0,C,false);
	$pdf->Cell( 9	,0.5,'shows great enthusiasm in performing school activities','LRB',0,J,true);
	
	$pdf->Ln();
	$pdf->Cell( 1.5	,0.4,'',0,0,L);
	$pdf->Cell( 0.6	,1.5,'2','LRTB',0,C,true);
	$pdf->Cell( 5.2	,1.5,$nmaPil,'LRTB',0,C,true);
	$pdf->Cell( 9	,0.5,substr($ktrPil,0,63),'LRT',0,J);
	
	$pdf->Ln();
	$pdf->Cell( 1.5	,0.4,'',0,0,L);
	$pdf->Cell( 0.6	,1.5,'',0,0,C,false);
	$pdf->Cell( 5.2	,1.5,'',0,0,C,false);
	$pdf->Cell( 9	,0.5,substr($ktrPil,63,63),'LR',0,J);//B
	
	$pdf->Ln();
	$pdf->Cell( 1.5	,0.4,'',0,0,L);
	$pdf->Cell( 0.6	,1.5,'',0,0,C,false);
	$pdf->Cell( 5.2	,1.5,'',0,0,C,false);
	$pdf->Cell( 9	,0.5,substr($ktrPil,126,63),'LRB',0,J);
	...
	$pdf->SetFont('Arial','U',8);
	$pdf->Cell( 0.75,0.4,'   '.$q1SKT.'   ','T',0,C,true);
	$pdf->SetFont('Arial','',8);
	...
	$pdf->SetFont('Arial','U',8);
	$pdf->Cell( 0.75,0.4,'   '.$q1IZN.'   ',0,0,C,true);
	$pdf->SetFont('Arial','',8);
	...
	$pdf->SetFont('Arial','U',8);
	$pdf->Cell( 0.75,0.4,'   '.$q1ALP.'   ','B',0,C,true);
	$pdf->SetFont('Arial','',8);
