<?php 
//----------------------------------------------------------------------------------------------------
//Program		: R1D04YSMP.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 21/12/2011
//Keterangan	: Fungsi-fungsi INPUT PROGRESS REPORT smp 7
//----------------------------------------------------------------------------------------------------
if(!defined("sister"))
{
...
// -------------------------------------------------- Class --------------------------------------------------
class R1D04YSMPclass
{
	// -------------------------------------------------- Layar Utama --------------------------------------------------
	function R1D04YSMP_Cari()
	{
		...
		<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
			<TR><TD><B>INPUT GRADING SHEET (JHS) 7-8</B></TD></TR>
			<TR></TR><TR></TR>
		</TABLE>
			
		<FORM ACTION='guru.php?mode=R1D04YSMP' METHOD='post'>
				...
				<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='0' WIDTH='100%' class='table02'>
					...
					while($data =mysql_fetch_array($result))
					{
						...
						<TR onMouseOver=\"this.className='highlight'\" onMouseOut=\"this.className='normal'\">
							<TD>$data[nmaplj]</TD>
							<TD><CENTER><a href='guru.php?mode=R1D04YSMP&kdeplj=$data[kdeplj]'><IMG src='../images/detil_e.gif' BORDER='0'></a></CENTER></TD>
						</TR>";
					}
				echo"	
				</TABLE>
...
//--..
			$query2	="	SELECT 		t_prgrptps_smp_k13.*
						...
						WHERE 		t_prgrptps_smp_k13.nis		='". mysql_escape_string($nis)."'	AND
									t_prgrptps_smp_k13.kdeplj	='". mysql_escape_string($kdeplj)."' AND 
									t_prgrptps_smp_k13.thn_ajaran		='". mysql_escape_string($thn_ajr)."'		";
			...
			<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
				...
				<TR><TD WIDTH='15%'>Class</TD>
					<TD>:
						...
						{
							/*if($data[kdekls]=='JHS-9A' OR $data[kdekls]=='JHS-9B')
							{
				...
				<tr>
					<td>Tahun Pelajaran</td><td> : 
						...
						<INPUT TYPE='hidden'	NAME='mode'		VALUE='R1D04YSMP'>
		...
		<FORM ACTION='guru.php' METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
				...
				<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='0' WIDTH='100%' class='table02'>
					<TR bgcolor='dedede'>
						...
						if ($pilihan=='detil'  AND $kdekls!='')
							echo"
							<TD WIDTH='4%' ROWSPAN='2'><CENTER><a href='guru.php?mode=R1D04YSMP&kdeplj=$kdeplj&kdekls=$kdekls&thn_ajr=$thn_ajr&pilihan=edit&kolom1=midtes'><span style='color: #FF0000;'><b>mid</b></span></CENTER></TD>";
						else
							echo"
					...
					<TR bgcolor='dedede'>";
						if ($pilihan=='detil'  AND $kdekls!='')
						{
							...
							while($y<13)
							{
								echo"<TD WIDTH='4%' HEIGHT='20'><CENTER><a href='guru.php?mode=R1D04YSMP&kdeplj=$kdeplj&kdekls=$kdekls&thn_ajr=$thn_ajr&pilihan=edit&kolom1=hw&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}	
							$y=1;
							while($y<13)
							{
								echo"<TD WIDTH='4%'><CENTER><a href='guru.php?mode=R1D04YSMP&kdeplj=$kdeplj&kdekls=$kdekls&thn_ajr=$thn_ajr&pilihan=edit&kolom1=prj&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}	
							$y=1;
							while($y<6)
							{
								echo"<TD WIDTH='4%'><CENTER><a href='guru.php?mode=R1D04YSMP&kdeplj=$kdeplj&kdekls=$kdekls&thn_ajr=$thn_ajr&pilihan=edit&kolom1=tes&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}
							//..k13
							$y=1;
							while($y<13)
							{
								echo"<TD WIDTH='4%' HEIGHT='20'><CENTER><a href='guru.php?mode=R1D04YSMP&kdeplj=$kdeplj&kdekls=$kdekls&thn_ajr=$thn_ajr&pilihan=edit&kolom1=ae&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}	
							$y=1;
							while($y<13)
							{
								echo"<TD WIDTH='4%'><CENTER><a href='guru.php?mode=R1D04YSMP&kdeplj=$kdeplj&kdekls=$kdekls&thn_ajr=$thn_ajr&pilihan=edit&kolom1=af&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}
							$y=1;
							while($y<6)
							{
								echo"<TD WIDTH='4%'><CENTER><a href='guru.php?mode=R1D04YSMP&kdeplj=$kdeplj&kdekls=$kdekls&thn_ajr=$thn_ajr&pilihan=edit&kolom1=ag&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}
			...
			<BR>
			<INPUT TYPE='button' 	VALUE='Subject' 	onClick=window.location.href='guru.php?mode=R1D04YSMP_Cari'>";
			if($pilihan=='detil' AND $kdekls!='')
			{
			...
			if($pilihan=='edit')
			{
				...
				<INPUT TYPE='hidden' NAME='mode' 		VALUE='R1D04YSMP_Save'>
	...
	function R1D04YSMP_Save()
	{
		...
		$query	="	SELECT 		t_mstbbt_smp_k13.*
					...
					WHERE		t_mstbbt_smp_k13.kdebbt='1HW'";
		...
		$query	="	SELECT 		t_mstbbt_smp_k13.*
					FROM 		t_mstbbt_smp_k13
					WHERE		t_mstbbt_smp_k13.kdebbt='2PRJ'";
		$result	=mysql_query($query) or die('Query gagal1');
		$data 	=mysql_fetch_array($result);
		$bbtX=$data[bbt] / 100;
		...
		$query	="	SELECT 		t_mstbbt_smp_k13.*
					FROM 		t_mstbbt_smp_k13
					WHERE		t_mstbbt_smp_k13.kdebbt='3TES'";
		$result	=mysql_query($query) or die('Query gagal1');
		$data 	=mysql_fetch_array($result);
		$bbtY=$data[bbt] / 100;
		...
		$query	="	SELECT 		t_mstbbt_smp_k13.*
					FROM 		t_mstbbt_smp_k13
					WHERE		t_mstbbt_smp_k13.kdebbt='4MID'";
		$result	=mysql_query($query) or die('Query gagal1');
		$data 	=mysql_fetch_array($result);
		$bbtZ=$data[bbt] / 100;
		...
		$query	="	SELECT 		t_mstbbt_smp_k13.*
					FROM 		t_mstbbt_smp_k13
					WHERE		t_mstbbt_smp_k13.kdebbt='5AE'";
		$result	=mysql_query($query) or die('Query gagal1');
		$data 	=mysql_fetch_array($result);
		$bbtAe=$data[bbt] / 100;
		...
		$query	="	SELECT 		t_mstbbt_smp_k13.*
					FROM 		t_mstbbt_smp_k13
					WHERE		t_mstbbt_smp_k13.kdebbt='6AF'";
		$result	=mysql_query($query) or die('Query gagal1');
		$data 	=mysql_fetch_array($result);
		$bbtAf=$data[bbt] / 100;
		...
		$query	="	SELECT 		t_mstbbt_smp_k13.*
					FROM 		t_mstbbt_smp_k13
					WHERE		t_mstbbt_smp_k13.kdebbt='7AG'";
		$result	=mysql_query($query) or die('Query gagal1');
		$data 	=mysql_fetch_array($result);
		$bbtAg=$data[bbt] / 100;
		...
		while($j<$i)
		{
			...
			$set	="	SET		t_prgrptps_smp_k13.nis		='". mysql_escape_string($nis)."',
								t_prgrptps_smp_k13.kdeplj	='". mysql_escape_string($kdeplj)."',
								t_prgrptps_smp_k13.thn_ajaran		='". mysql_escape_string($thn_ajr)."',
								t_prgrptps_smp_k13."."$nliw"."	='". mysql_escape_string($nli)."',
								t_prgrptps_smp_k13.kdeusr	='". mysql_escape_string($kdeusr)."',
								t_prgrptps_smp_k13.tglrbh	='". mysql_escape_string($tglrbh)."',
								t_prgrptps_smp_k13.jamrbh	='". mysql_escape_string($jamrbh)."'"; 

			$query	="	SELECT 		t_prgrptps_smp_k13.*
						FROM 		t_prgrptps_smp_k13
						WHERE 		t_prgrptps_smp_k13.nis	='". mysql_escape_string($nis)."'	AND
									t_prgrptps_smp_k13.kdeplj	='". mysql_escape_string($kdeplj)."' AND 
									t_prgrptps_smp_k13.thn_ajaran	='". mysql_escape_string($thn_ajr)."'		";
			...
			if($data[nis]=='')
			{
			  	$query 	="	INSERT INTO t_prgrptps_smp_k13 ".$set; 
				$result	=mysql_query($query) or die (error("Data tidak berhasil di simpan"));
			}
			else
			{
				$query 	="	UPDATE 	t_prgrptps_smp_k13 ".$set.
						"	WHERE 	t_prgrptps_smp_k13.nis	='". mysql_escape_string($nis)	."'	AND
									t_prgrptps_smp_k13.kdeplj	='". mysql_escape_string($kdeplj)	."' AND 
									t_prgrptps_smp_k13.thn_ajaran	='". mysql_escape_string($thn_ajr)."'	";
		...
		while($j<$i)
		{
			...
			$query2 ="	SELECT 		t_prgrptps_smp_k13.*
						...
						WHERE		t_prgrptps_smp_k13.nis	='$nis'		AND
									t_prgrptps_smp_k13.kdeplj='$kdeplj' AND 
									t_prgrptps_smp_k13.thn_ajaran	='$thn_ajr'	";
		...
		while($j<$i)
		{
			...
			$set	="	SET		t_prgrptps_smp_k13."."$avehw"."		='". mysql_escape_string(number_format($avghw))."',
								t_prgrptps_smp_k13."."$aveprj"."	='". mysql_escape_string(number_format($avgprj))."',
								t_prgrptps_smp_k13."."$avetes"."	='". mysql_escape_string(number_format($avgtes))."',
								t_prgrptps_smp_k13."."$avemid"."	='". mysql_escape_string(number_format($midtes30))."',
								t_prgrptps_smp_k13."."$aveae"."		='". mysql_escape_string(number_format($avgae))."',
								t_prgrptps_smp_k13."."$aveaf"."		='". mysql_escape_string(number_format($avgaf))."',
								t_prgrptps_smp_k13."."$aveag"."		='". mysql_escape_string(number_format($avgag))."',
								t_prgrptps_smp_k13."."$qg_k13_"."	='". mysql_escape_string($QG_k13)."',
								t_prgrptps_smp_k13."."$qg_k14_"."	='". mysql_escape_string($QG_k14)."',
								t_prgrptps_smp_k13."."$akh"."	='". mysql_escape_string($nliakh)."' "; 
			$query 	="	UPDATE 	t_prgrptps_smp_k13 ".$set.
					"	WHERE 	t_prgrptps_smp_k13.nis	='". mysql_escape_string($nis)	."'	AND
								t_prgrptps_smp_k13.kdeplj	='". mysql_escape_string($kdeplj)	."' AND 
								t_prgrptps_smp_k13.thn_ajaran	='". mysql_escape_string($thn_ajr)	."'	";
		...
		echo"<meta http-equiv='refresh' content=\"0;url=guru.php?mode=R1D04YSMP&kdeplj=$kdeplj&kdekls=$kdekls&thn_ajr=$thn_ajr&pilihan=detil\">\n";
 	}		
}//akhir class
?>