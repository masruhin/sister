<?php
//----------------------------------------------------------------------------------------------------
//Program		: R1D04OSMP.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 21/12/2011
//Keterangan	: Fungsi-fungsi SISWA rapot smp 7 K13
//----------------------------------------------------------------------------------------------------
if(!defined("sister"))
{
    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04OSMP()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<FORM ACTION='pendataan/R1D04OSMP_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT MID TERM REPORT (JHS) 7-8</B></TD></TR>
           		<TR></TR><TR></TR>
