	...
	function R1D04X()
	{
		...
		while($data = mysql_fetch_array($result)) // .. d
		{
			...
			// akhir buatan
				...
				/*$query2	="	SELECT 		t_prgrptps_sd.*
						FROM 		t_prgrptps_sd
						WHERE 		t_prgrptps_sd.nis		='". mysql_escape_string($kdekls)."' AND
									t_prgrptps_sd.kdeplj	='". mysql_escape_string($kdeplj)."'";
				//t_prgrptps_sd.nis		='". mysql_escape_string($kdekls)."' AND
				$result2 =mysql_query($query2);
				$data2 	 =mysql_fetch_array($result2);
				...
				while($y<9)
				{
					$cell[$i][$y+26]=$data2['hw'."$sms"."$nlitrm"."$y"];
					$y++;
				}
				
				$y=1;
				$cell[$i][$y+34]=$data2['st'."$sms"."$nlitrm"."9"]; // ST hw				

				$y=1;
				while($y<9)
				{
					$cell[$i][$y+35]=$data2['prj'."$sms"."$nlitrm"."$y"];
					$y++;
				}

				$y=1;
				$cell[$i][$y+43]=$data2['st_'."$sms"."$nlitrm".'9']; // ST prj
				
				$y=1;
				while($y<8)
				{
					$cell[$i][$y+44]=$data2['tes'."$sms"."$nlitrm"."$y"];
					$y++;
				}
			...
			<DIV style='overflow:auto;;width:100%;height:340px;padding-right:-2px;'>
				...
				//{
					echo"<TR bgcolor='dedede'>
						...
						<TD WIDTH='25%' COLSPAN='9' HEIGHT='20'><CENTER>Knowledge Assessments (KA)	    	</CENTER></TD>";
						
					echo"<TD WIDTH='25%' COLSPAN='9'><CENTER>Skills Assessments (SA)	    	</CENTER></TD>";
					
					echo"<TD WIDTH='24%' COLSPAN='7'><CENTER>Spiritual & Social Behavior (7 CORE VALUES)	    	</CENTER></TD>";
					...
					<TR bgcolor='dedede'>";
						if ($pilihan=='detil'  AND $kdekls!='')
						{
							...
							while($y<9)
							{
								echo"<TD WIDTH='4%' HEIGHT='20'><CENTER><a href='guru.php?mode=R1D04X&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=hw&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}	
							//st
							$y=1;
								echo"<TD WIDTH='4%' HEIGHT='20'><CENTER><a href='guru.php?mode=R1D04X&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=st&kolom2=9'><span style='color: #FF0000;'><b>ST</b></span></CENTER></TD>";
							
							$y=1;
							while($y<9)
							{
								echo"<TD WIDTH='4%'><CENTER><!--R--><a href='guru.php?mode=R1D04X&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=prj&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}
							//st_
							$y=1;
								echo"<TD WIDTH='4%' HEIGHT='20'><CENTER><a href='guru.php?mode=R1D04X&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=st_&kolom2=9'><span style='color: #FF0000;'><b>ST</b></span></CENTER></TD>";
							
							$y=1;
							while($y<8)
							{
								echo"<TD WIDTH='4%'><CENTER><a href='guru.php?mode=R1D04X&kdeplj=$kdeplj&kdekls=$kdekls&pilihan=edit&kolom1=tes&kolom2=$y'><span style='color: #FF0000;'><b>$y</b></span></CENTER></TD>";
								$y++;
							}	
						}
						else
