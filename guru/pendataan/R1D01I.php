...
class R1D01Iclass
{
	...
	function R1D01I()
	{
		...
		function sf()
		{ 
			document.f1.nmamtr.focus();//kdeplj
		}
		</SCRIPT>";
		...
		echo"
		<BODY onload='sf();'>
			<SCRIPT TYPE='text/javascript' src='../guru/js/R1D01I.js'></SCRIPT>
			...
			<FORM ID='validasi'  ACTION='guru.php'METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
				<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
					...
					<INPUT TYPE='hidden' 	NAME='kdemtr'  	id='kdemtr'value='$kdemtr'>
					<INPUT TYPE='hidden' 	NAME='kdegru' id='kdegru'	VALUE='$user'>
					<input type='hidden' name='kdeplj' id='kdeplj' class='kdeplj' value='$kdeplj' />
					<input type='hidden' name='kdeklm' id='kdeklm' class='kdeklm' value='$kdeklm' />
					...
					<INPUT TYPE='hidden' NAME='mode'  id='mode'	VALUE='R1D01I_Save_Item'></TR>
				</TABLE>	
				...
				<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
								...
								<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='0' CELLSPACING='0' WIDTH='100%' class='table02'>
									...
									<FORM  id='validasi'>
										<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='0' CELLSPACING='0' WIDTH='100%' class='table02'>";
											...
											<SCRIPT TYPE='text/javascript' src='../guru/js/R1D01I_hapus.js'></SCRIPT>
										</TABLE>
									</FORM>
								</TABLE>
							</DIV>	
					...
					<TR>
						<TD ALIGN='left'>
							<INPUT TYPE='button' VALUE='New' onClick=window.location.href='guru.php?mode=R1D01I&pilihan=tambah_general'>";

							if ($pilihan=='detil_general')
							{
								echo"
								<INPUT TYPE='button' VALUE='Tambah Materi' onClick=window.location.href='guru.php?mode=R1D01I&kdemtr=$kdemtr&pilihan=tambah_item'>
								<INPUT TYPE='button' VALUE='Hapus' onClick='confirmation()'>";
							}	
							if ($pilihan=='detil_general' or $pilihan=='tambah_item')
							{
								//echo"<INPUT TYPE='button' VALUE='Print' 	onClick=window.open('pendataan/R1D01I_Cetak.php?kdemtr=$kdemtr')>";
							}
						echo"
						</TD>
					</TR>
	...
	function R1D01I_Save_Item()
	{
		...
		//{
			...
			$query 	="INSERT INTO g_gnrrpp ".$set;
			$result =mysql_query ($query) or die (error("Data tidak berhasil di Input 22"));
        //}
		...
		echo"<meta http-equiv='refresh' content=\"0;url=guru.php?mode=R1D01I&kdemtr=$kdemtr&pilihan=tambah_item\">\n";
	}
