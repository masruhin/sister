    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04LPGab()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<FORM ACTION='pendataan/R1D04LPGab_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>Cetak Laporan Perkembangan Anak (KB)</B></TD></TR>
           		<TR></TR><TR></TR>
