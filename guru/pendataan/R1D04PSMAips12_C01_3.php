<?php 
//----------------------------------------------------------------------------------------------------
//Program		: R1D04PSMAips12_C01.php
//Di Edit oleh	: ITPCS
...
while($y<$x)
{
	...
	$smav1ECN='';
	if($akh2ECN==0)//$ahw2ECN
		$smav1ECN=$akh1ECN;//$ahw1ECN
	else
	{
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,$akh3ECN,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3ECN,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3ECN,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,$akh3SCL,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3SCL,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3SCL,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,$akh3GGRY,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3GGRY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3GGRY,'LRTB',0,C,true);
