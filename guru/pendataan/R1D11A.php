...
class R1D11Aclass
{
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D11A()
 	{
		...
		<FORM ACTION='pendataan/R1D11A_C01_HTML.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>CETAK RAPOR DIKNAS (SD) COVER 1</B></TD></TR>
           		<TR></TR><TR></TR>
