...
//{
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "competencies expected of him or her. The first term is the entry", '', 0, J, true);							$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,729,81), 'LRB', 0, J, true);
