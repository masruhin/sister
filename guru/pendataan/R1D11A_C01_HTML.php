...
while($y<$x)
{
	...
	echo"
		<div class='pb_after'>
			...
			<br/>
			<center>
				<img src='../../images/Tut_Wuri_Handayani.jpg' height='120px' width='120px' />
				<br/>
				<br/>
				...
				Jl. Taman Palem Raya, No.1 Blok D1,
				<br/>
				Taman Villa Meruya, Kembangan, Jakarta Barat,
				<br/>
				DKI Jakarta
				<br/>
				...
				<img src='../../images/logo_sjs_meruya.png' height='150px' width='150px' />
