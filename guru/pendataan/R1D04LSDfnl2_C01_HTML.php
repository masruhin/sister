...
while($j<$i)
{
	...
	while($j<$i AND $x<=30)
	{
		...
		echo"
			<tr>
				<td align='center' title='Religion Q3 $x. $nmassw_d'>
					$q1RLG
				</td>
				<td align='center' title='Religion Q4 $x. $nmassw_d'>
					$q2RLG
				</td>
		...
		echo"
				...
				<td align='center' title='CME Q3 $x. $nmassw_d'>
					$q1CME
				</td>
				<td align='center' title='CME Q4 $x. $nmassw_d'>
					$q2CME
				</td>
		...
		echo"
				...
				<td align='center' title='Bhs. Indo. Q3 $x. $nmassw_d'>
					$q1BIN
				</td>
				<td align='center' title='Bhs. Indo. Q4 $x. $nmassw_d'>
					$q2BIN
				</td>
		...
		echo"
				...
				<td align='center' title='Maths Q3 $x. $nmassw_d'>
					$q1MTH
				</td>
				<td align='center' title='Maths Q4 $x. $nmassw_d'>
					$q2MTH
				</td>
		...
		echo"
				...
				<td align='center' title='Science Q3 $x. $nmassw_d'>
					$q1SCN
				</td>
				<td align='center' title='Science Q4 $x. $nmassw_d'>
					$q2SCN
				</td>
		...
		echo"
				...
				<td align='center' title='Social Q3 $x. $nmassw_d'>
					$q1SCLS
				</td>
				<td align='center' title='Social Q4 $x. $nmassw_d'>
					$q2SCLS
				</td>
		...
		echo"
				...
				<td align='center' title='Art Q3 $x. $nmassw_d'>
					$q1ART
				</td>
				<td align='center' title='Art Q4 $x. $nmassw_d'>
					$q2ART
				</td>
		...
		echo"
				...
				<td align='center' title='Computer Q3 $x. $nmassw_d'>
					$q1COM
				</td>
				<td align='center' title='Computer Q4 $x. $nmassw_d'>
					$q2COM
				</td>
		...
		echo"
				...
				<td align='center' title='PE Q3 $x. $nmassw_d'>
					$q1PE
				</td>
				<td align='center' title='PE Q4 $x. $nmassw_d'>
					$q2PE
				</td>
		...
		echo"
				...
				<td align='center' title='English Q3 $x. $nmassw_d'>
					$q1ENG
				</td>
				<td align='center' title='English Q4 $x. $nmassw_d'>
					$q2ENG
				</td>
		...
		echo"
				...
				<td align='center' title='Mandarin Q3 $x. $nmassw_d'>
					$q1MND
				</td>
				<td align='center' title='Mandarin Q4 $x. $nmassw_d'>
					$q2MND
				</td>
