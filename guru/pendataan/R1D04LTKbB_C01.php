...
$qLGKG	="	SELECT 		 t_learnrcd_tk_akr.*
			...
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='KG-B1' OR t_learnrcd_tk_akr.kdekls='KG-B2' ) AND t_learnrcd_tk_akr.kdeplj='AKG-A' ";
...
$qLGKG2	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='KG-B1' OR t_learnrcd_tk_akr.kdekls='KG-B2' ) AND t_learnrcd_tk_akr.kdeplj='AKG-B' ";
...
$qLGKG3	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='KG-B1' OR t_learnrcd_tk_akr.kdekls='KG-B2' ) AND t_learnrcd_tk_akr.kdeplj='AKG-C' ";
...
$qLGKG4	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='KG-B1' OR t_learnrcd_tk_akr.kdekls='KG-B2' ) AND t_learnrcd_tk_akr.kdeplj='AKG-D' ";
...
$qLGKG5	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='KG-B1' OR t_learnrcd_tk_akr.kdekls='KG-B2' ) AND t_learnrcd_tk_akr.kdeplj='AKG-E' ";
...
$qLGKG6	="	SELECT 		 t_learnrcd_tk_akr.*
			FROM 		 t_learnrcd_tk_akr
			WHERE		 t_learnrcd_tk_akr.nis='$kdekls' AND ( t_learnrcd_tk_akr.kdekls='KG-B1' OR t_learnrcd_tk_akr.kdekls='KG-B2' ) AND t_learnrcd_tk_akr.kdeplj='AKG-F' ";
...
//{
	...
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, "KELOMPOK        : TK B", '', 0, L, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,0,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,30,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,60,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,90,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,120,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,150,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,180,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,210,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,240,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,270,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,300,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN,330,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,0,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,30,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,60,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,90,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,120,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,150,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,180,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,210,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,240,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN2,270,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,0,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,30,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,60,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,90,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,120,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,150,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,180,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,210,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,240,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,270,30), 'LR', 0, J, true);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,300,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,330,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,360,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,390,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,420,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,450,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,480,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,510,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,540,30), 'LR', 0, J, true);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,570,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,600,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,630,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,660,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,690,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,720,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,780,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,810,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN4,840,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,0,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,30,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,60,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,90,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,120,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,150,30), 'LR', 0, J, true);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,180,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,210,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,240,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,270,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,300,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,330,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,360,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,390,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,420,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,450,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,480,30), 'LR', 0, J, true);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,510,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,540,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,570,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,600,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,630,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,660,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,690,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,720,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN3,750,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,0,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,30,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,60,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,90,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,120,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,150,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,180,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,210,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,240,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,270,30), 'LR', 0, J, true);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,300,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,330,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,360,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,390,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,420,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,450,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN5,480,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,0,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,30,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,60,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,90,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,120,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	...
	$pdf->Cell(5.3, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,150,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,180,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,210,30), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,240,30), 'LR', 0, J, true);
	$pdf->Ln(0.5);
	$pdf->Cell( 0.05	,0.5,'','',0,C,false);
	$pdf->Cell(0.5, 1, "", '', 0, C, false);
	$pdf->Cell(14.5, 1, "", '', 0, L, false);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(5.7, 0.5, substr($q4KMN6,270,30), 'LR', 0, J, true);
