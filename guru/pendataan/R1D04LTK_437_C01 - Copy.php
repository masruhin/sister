...
//{
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "There are four terms in the whole academic year in which we", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,567,81), 'LRB', 0, J, true);
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "competencies expected of him or her. The first term is the entry", '', 0, J, true);							$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 8.9	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);				$pdf->Cell(1, 0.5, "3. Mathematical/Cognitive Development", '', 0, L, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN3,0,81), 'LRT', 0, J, true);	
	
	
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7, 0.5, "knowledge and the initial experiences in school. The second and", '', 0, L, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q3KMN3,81,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,162,81), 'LR', 0, J, true);
	//9
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "development is described on these stages and the fourth term", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,243,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,324,81), 'LRB', 0, J, true);
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "performance is described based on the extent of achievement", '', 0, J, true);								
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "or progress made as expected of him or her at the end of the", '', 0, J, true);								$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 8.9	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(1, 0.5, "4. Creative Development", '', 0, L, true);	
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7, 0.5, "May this record book serves its purpose with your feedbacks,", '', 0, L, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q3KMN4,162,81), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "development of your child throughout the year.", '', 0, J, true);											$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q3KMN4,324,81), 'LRB', 0, J, true);																									
	...
	$pdf->Cell(1.25	, 0.5, '', '', 0, C, FALSE);																						$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 2.9	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);				$pdf->Cell(1, 0.5, "5. Physical Development (Gross and Fine Motor Skills)", '', 0, L, true);
	//15
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5,"", '', 0, J, true);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);				$pdf->Cell(11.5, 0.5, substr($q3KMN5,0,81), 'LRT', 0, J, true);
	...
	$pdf->Cell(1.25	, 1.5, '', '', 0, C, true);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN5,81,81), 'LR', 0, J, true);
	//16
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell( 8	,0.5,'','',0,C,false);
	$pdf->Cell(2, 0.5, "Saint John's School", '', 0, J, true);																			$pdf->SetFont('Arial','',9);	$pdf->Cell( 6.9	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN5,162,81), 'LR', 0, J, true);
	//16
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	...
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, '', '', 0, J, true);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN5,324,81), 'LRB', 0, J, true);
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[5][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 9	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q1KMN2,405,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[8][0], 'LRT', 0, C, true);									
		
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BU',11);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.5, 0.5, "D. Confidence and Self-esteem", 'LRT', 0, L, true);					$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 2.5	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);				$pdf->Cell(1, 0.5, "3. Mathematical/Cognitive Development", '', 0, L, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[9][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN3,0,81), 'LRT', 0, J, true);	
	//9
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[8][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,81,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1.5, $q3nli[10][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,162,81), 'LR', 0, J, true);
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[9][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,243,81), 'LR', 0, J, true);
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[9][0] ,106,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,324,81), 'LRB', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[11][0], 'LRT', 0, C, true);									
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[12][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 2.5	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(1, 0.5, "4. Creative Development", '', 0, L, true);	
	
	$pdf->Ln();
	$pdf->SetFont('Arial','BU',11);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.5, 0.5, "E. Behaviour and self-control", 'LRT', 0, L, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN4,0,81), 'LRT', 0, J, true);	
	...
	$pdf->Cell(1.25	, 1, $q3nli[13][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN4,81,81), 'LR', 0, J, true);
	//13
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[12][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);			$pdf->Cell( 9	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q1KMN4,162,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[14][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN4,243,81), 'LRB', 0, J, true);
	...
	$pdf->Cell(1.25	, 1.5, $q3nli[16][0], 'LRTB', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN5,0,81), 'LRT', 0, J, true);
	//16
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(7	, 0.5, '', '', 0, J, false);												$pdf->SetFont('Arial','',9);	$pdf->Cell( 9	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN5,243,81), 'LRB', 0, J, true);
