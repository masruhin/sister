...
//{
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell( 0.5	,0.4,'','',0,C,false);
	$pdf->Cell(3, 0.5, "to provide your child with a wide range of opportunities to", '', 0, L, true);									$pdf->Cell( 10	,0.4,'','',0,C,false);	$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q3KMN,324,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, '', '', 0, C, false);
	$pdf->Cell(2.25	, 1,'', '', 0, C, false);										
	$pdf->Cell(1.25	, 1, '', '', 0, C, false);																								$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q3KMN,405,81), 'LRB', 0, J, true);
	//3
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	...
	$pdf->Cell(1.25	, 1.5, '', '', 0, C, false);																						$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 2.9	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);				$pdf->Cell(1, 0.5, "2. Communication, Language and Literacy", '', 0, L, true);
	//4
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "through teaching and learning processes throughout the school", '', 0, J, true);							$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN2,0,81), 'LRT', 0, J, true);
	//4
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "year are herein described for your reference in each quarter or", '', 0, J, true);							$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,81,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, '', '', 0, C, false);
	$pdf->Cell(2.25	, 1, '', '', 0, C, false);
	$pdf->Cell(1.25	, 1, '', '', 0, C, false);																							$pdf->SetFont('Arial','',9);	$pdf->Cell( 3.4	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q3KMN2,162,81), 'LR', 0, J, true);
	//5
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "for expectations of children's achievements throughout the", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);			$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q3KMN2,243,81), 'LR', 0, J, true);
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7, 0.5, "\"Early Years Foundation Stage\".", '', 0, L, true);															$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,324,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, '', '', 0, C, false);
	$pdf->Cell(2.25	, 1, '', '', 0, C, false);
	$pdf->Cell(1.25	, 1, '', '', 0, C, false);																							$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,405,81), 'LR', 0, J, true);
	//6
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "There are four terms in the whole academic year in which we", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,486,81), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,567,81), 'LRB', 0, J, true);
	//7
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "competencies expected of him or her. The first term is the entry", '', 0, J, true);							
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7, 0.5, "knowledge and the initial experiences in school. The second and", '', 0, L, true);								$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 8.9	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);				$pdf->Cell(1, 0.5, "3. Mathematical/Cognitive Development", '', 0, L, true);
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "development is described on these stages and the fourth term", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,81,81), 'LR', 0, J, true);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "is the exit level or the final stage where your child's", '', 0, J, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,162,81), 'LR', 0, J, true);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	...
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "performance is described based on the extent of achievement", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,243,81), 'LR', 0, J, true);	
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "or progress made as expected of him or her at the end of the", '', 0, J, true);								$pdf->SetFont('Arial','',9);	$pdf->Cell( 9.4	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q3KMN3,324,81), 'LRB', 0, J, true);	
