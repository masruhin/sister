...
class R1D04Yclass
{
	...
	function R1D04Y_Cari()
	{
		...
		<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
			<TR><TD><B>INPUT PROGRESS REPORT (JHS) 8-9</B></TD></TR>
			<TR></TR><TR></TR>
		</TABLE>
	...
	function R1D04Y()
	{
		...
		while($data = mysql_fetch_array($result))
		{
			...
			while($y<6)
			{
				$cell[$i][$y+30]=$data2['ag'."$sms"."$nlitrm"."$y"];
				$y++;
			}
			
			$cell[$i][$y+35]=$data2['midtes'."$sms"."$nlitrm"];
			...
			<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
				...
				<TR><TD WIDTH='15%'>Class</TD>
					<TD>:
						...
						{
							if($data[kdekls]=='JHS-7A' OR $data[kdekls]=='JHS-7B')
							{
								
							}
							else//if($data[kdekls]=='JHS-8A' OR $data[kdekls]=='JHS-8B' OR $data[kdekls]=='JHS-9A' OR $data[kdekls]=='JHS-9B')
							{
