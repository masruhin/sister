...
// -------------------------------------------------- Class --------------------------------------------------
class R1D04LSMAK13class
{
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	function R1D04LSMAK13()
 	{
		...
		$midtrm='1';
	 	...
	 	echo"
		<FORM ACTION='pendataan/R1D04LSMAK13_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT MID TERM LEDGER (SHS) 10-11 IPA</B></TD></TR>
           		<TR></TR><TR></TR>
				<TR><TD WIDTH='15%'>Class</TD>
					<TD WIDTH='85%'>:
						...
						{
							if($data[kdekls]=='SHS-10IPA' OR $data[kdekls]=='SHS-11IPA')
							{
