...
//{
	...
	$pdf->Cell(1.25	, 1, $q3nli[1][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q1KMN,0,90), 'LRT', 0, J, true);
	//1
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	...
	$pdf->Cell(1.25	, 1, $q3nli[2][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q1KMN,180,90), 'LR', 0, J, true);
	//2
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->SetFont('Arial','BU',11);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.5, 0.5, "B. Disposition and attitude", 'LRT', 0, L, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q1KMN,360,90), 'LRB', 0, J, true);
	...
	$pdf->Cell(1.25	, 1.5, $q3nli[4][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN2,0,90), 'LRT', 0, J, true);
	//4
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[5][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);			$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q1KMN2,270,90), 'LR', 0, J, true);
	//5
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[6][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 2.5	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);				$pdf->Cell(1, 0.5, "3. Mathematical/Cognitive Development", '', 0, L, true);
	//6
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[7][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);			$pdf->Cell(11.5, 0.5, substr($q1KMN3,90,90), 'LR', 0, J, true);
	//7
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[8][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,270,90), 'LR', 0, J, true);
	
	
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BU',11);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.5, 0.5, "D. Confidence and Self-esteem", 'LRT', 0, L, true);					$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(11.5, 0.5, substr($q1KMN3,360,90), 'LRB', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[9][0], 'LRT', 0, C, true);
	//9
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr[8][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 8.5	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);										$pdf->Cell(1, 0.5, "4. Creative Development", '', 0, L, true);	
	...
	$pdf->Cell(1.25	, 1.5, $q3nli[10][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN4,0,90), 'LRT', 0, J, true);	
	//10
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[11][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN4,270,90), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[12][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->SetFillColor(255,255,255);									$pdf->Cell(11.5, 0.5, substr($q1KMN4,360,90), 'LRB', 0, J, true);	
	...
	$pdf->Cell(1.25	, 1, $q3nli[13][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 2.5	,0.5,'','',0,C,false);		$pdf->SetFillColor(255,255,255);				$pdf->Cell(1, 0.5, "5. Physical Development (Gross and Fine Motor Skills)", '', 0, L, true);	
	//13
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 0.5, $q3nli[14][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);	$pdf->SetFillColor(255,255,255);				$pdf->Cell(11.5, 0.5, substr($q1KMN5,90,90), 'LR', 0, J, true);
	...
	$pdf->Cell(1.25	, 1, $q3nli[15][0], 'LRT', 0, C, true);										$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN5,180,90), 'LR', 0, J, true);						
	//15
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 1.5, $q3nli[16][0], 'LRTB', 0, C, true);									$pdf->SetFont('Arial','',9);	$pdf->Cell( 3	,0.4,'','',0,C,false);		$pdf->Cell(11.5, 0.5, substr($q1KMN5,360,90), 'LRB', 0, J, true);						
	//16
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	...
	$pdf->Cell(1.25	, 1.0, $q3nliB[17][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',10);	$pdf->Cell(2	,0.5,'','',0,C,false);						$pdf->Cell(0.5	, 0.5, "12", 'LT', 0, C, true);			$pdf->Cell(7	, 0.5, substr( $nmektr3[11][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.5, $q1nliC[12][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.5, $q2nliC[12][0], 'LRT', 0, C, true);		$pdf->Cell(2.25	, 0.5, $smstr1C[12][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 1, $q3nliC[12][0], 'LRT', 0, C, true);
	//7
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(0.5	, 0.5, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.5, substr( $nmektr2[16][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',10);	$pdf->Cell( 8	,0.5,'','',0,C,false);						$pdf->Cell(0.5	, 0.5, "13", 'LT', 0, C, true);			$pdf->Cell(7	, 0.5, substr( $nmektr3[12][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.25	, 0.5, $q1nliC[13][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 0.5, $q2nliC[13][0], 'LRT', 0, C, true);		$pdf->Cell(2.25	, 0.5, $smstr1C[13][0], 'LRT', 0, C, true);		$pdf->Cell(1.25	, 1, $q3nliC[13][0], 'LRT', 0, C, true);
