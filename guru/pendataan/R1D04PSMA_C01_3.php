<?php 
//----------------------------------------------------------------------------------------------------
//Program		: R1D04PSMA_C01_3.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 07/12/2011
//Keterangan	: Cetak SISWA ( versi 1 lembar ) rapot sma 11 ipa
//----------------------------------------------------------------------------------------------------
...
while($y<$x)
{
	...
	if($q3RBT!='')
	{
		$nma3c='Interest(Robotic/Manner/Scouting)';
		$ktr3c=$q3RBT;
	}
	//av1
	$ave3a='';
	...
	if($q3CLB!='')
	{
		$nma5c='Interest(Science & Math Club/English Club)';
		$ktr5c=$q3CLB;
	}
	//av1
	$ave5a='';
	...
	$pdf->Cell( 2	,0);
	//$pdf->Image($signature, 8.25, 24.75, 4.577234, 2.143098);
	$pdf->Cell( 7	,0.4,'','',0,C);
	$pdf->Cell( 1	,0);
