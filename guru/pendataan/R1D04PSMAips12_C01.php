...
if($sms=='1' AND $midtrm=='2')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04PSMAips12_C01_2.php?kdekls=$kdekls&thn_ajr=$thn_ajr\">\n";
if($sms=='2' AND $midtrm=='1')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04PSMAips12_C01_3.php?kdekls=$kdekls&thn_ajr=$thn_ajr\">\n";
...
while($y<$x)
{
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$ahw2ECN
	$pdf->Cell( 0.75	,0.5,$akh1ECN,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$ahw2SCL
	$pdf->Cell( 0.75	,0.5,$akh1SCL,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$ahw2GGRY
	$pdf->Cell( 0.75	,0.5,$akh1GGRY,'LRTB',0,C,true);
	...
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr7a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
