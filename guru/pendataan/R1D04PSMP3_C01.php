...
while($y<$x)
{
	...
	while ($id<99)
	{
		...
		if($nmasbj!='')
		{
			...
			if($kdeplj=='BLGY' OR $kdeplj=='PHY' OR $kdeplj=='ECN' OR $kdeplj=='HIST' OR $kdeplj=='GGRY')
			{
				...
				$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);
				$pdf->SetFillColor(255,255,255);
			}
			else
			{
				...
				if($av1!='DF')
					$avg1 = number_format($av1,0,',','.');
				
				$pdf->SetFillColor(255,255,255);
				$pdf->Cell( 1	,0.5,$avg1,'LRTB',0,C,true);
				$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);
				$pdf->SetFillColor(255,255,255);
			}*/
	...
	$pdf->Cell( 1	,0.5,$akh21RLG,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2RLG,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell(5.7	,0.5,'Civis/Moral Education','LRTB',0,L,true);
	$pdf->Cell( 2	,0.5,'72','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$akh11CME,'LRTB',0,C,true);//$q1
	$pdf->Cell( 1	,0.5,$akh12CME,'LRTB',0,C,true);//$q2
	$pdf->Cell( 1	,0.5,$av1CME,'LRTB',0,C,true);//$av1
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21CME,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2CME,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21BIN,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2BIN,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21ENG,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2ENG,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21MTH,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2MTH,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$q3IPA,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2IPA,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	$pdf->SetFont('Arial','',8);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.5,$akh21BLGY,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	...
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$lg1
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.5,$akh21PHY,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$q3IPS,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2IPS,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	$pdf->SetFont('Arial','',8);
	...
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$lg1
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.5,$akh21ECN,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$lg1
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.5,$akh21HIST,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$lg1
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.5,$akh21GGRY,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21ART,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2ART,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21PE,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2PE,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21ICT,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2ICT,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21FOR,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2FOR,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.5,$lg1,'LRTB',0,C,true);//$lg1
	$pdf->Cell( 1	,0.5,$akh21PLKJ,'LRTB',0,C,true);//$q3
	$pdf->Cell( 1	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 1	,0.5,$av2PLKJ,'LRTB',0,C,true);//$av2
	$pdf->Cell( 1	,0.5,$lg2,'LRTB',0,C,true);//$lg2
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$ktrPil1c		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$ktrPil2c		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$ktrPil3c		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$ktrPil4c		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$ktrPil5c		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$q3ATT		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$q3DIL		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$q3ORD		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$q3SKT		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$q3IZN		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	...
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 1	,0.4,$q3ALP		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 1	,0.4,''		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 1	,0.4,''			,'LRTB',0,C,true);
