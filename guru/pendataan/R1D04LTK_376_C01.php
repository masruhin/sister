...
//{
	...
	$pdf->Cell(1.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(2.25	, 1,'', '', 0, C, FALSE);
	$pdf->Cell(1.25	, 1, '', '', 0, C, FALSE);																							$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 3.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,567,81), 'LR', 0, J, true);
	//7
	$pdf->Ln(0.5);
	$pdf->SetFont('Arial','BI',12);
	$pdf->Cell(0.5	, 0.5, "", '', 0, C, true);
	$pdf->Cell(7	, 0.5, "competencies expected of him or her. The first term is the entry", '', 0, J, true);							$pdf->SetFont('Arial','',9);	$pdf->SetFillColor(255,255,255);				$pdf->Cell( 9.4	,0.4,'','',0,C,false);	$pdf->Cell(11.5, 0.5, substr($q3KMN2,648,81), 'LRB', 0, J, true);
