...
class R1D01H2class
{
		...
		<BODY onload='sf();'>
			...
			<FORM ID='validasi'  ACTION='guru.php'METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
				<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
					<TR><TD COLSPAN='2'><B>CURRICULUM PLAN SEMESTER 2</B></TD></TR>
					<TR></TR><TR></TR>
					...
					<INPUT TYPE='hidden' NAME='mode'  id='mode'	VALUE='R1D01H2_Save_Item'></TR>
				</TABLE>	
				...
				<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%'>
											...
											{   $id=$data['id'];
												...
												<TR onMouseOver=\"this.className='highlight'\" onMouseOut=\"this.className='normal'\">
													...
													if ($pilihan=='detil_general' or $pilihan=='tambah_item')
													{
                                                        ...
                                                        echo"
														<TD WIDTH='7%'><CENTER><a href='../files/semester2/$kdemtr/$nmamtr2.$type'target='_blank'><IMG src='../images/detil_e.gif' BORDER='0'></a></CENTER></TD>";
                                                        if($kdegru!=$user)
                                                        {
                                                          echo"
					...
					<TR>
						<TD ALIGN='left'>
							<INPUT TYPE='button' VALUE='New' onClick=window.location.href='guru.php?mode=R1D01H2&pilihan=tambah_general'>";

							if ($pilihan=='detil_general')
							{
								echo"
								<INPUT TYPE='button' VALUE='Tambah Materi' onClick=window.location.href='guru.php?mode=R1D01H2&kdemtr=$kdemtr&pilihan=tambah_item'>
								<INPUT TYPE='button' VALUE='Hapus' onClick='confirmation()'>";
							}	
							if ($pilihan=='detil_general' or $pilihan=='tambah_item')
							{
								//echo"<INPUT TYPE='button' VALUE='Print' 	onClick=window.open('pendataan/R1D01H2_Cetak.php?kdemtr=$kdemtr')>";
							}
						echo"
						</TD>
					</TR>
	...
	function R1D01H2_Save_Item()
	{
        ...
        $handle = is_dir("../files/semester2/$kdemtr");
        if($handle=='')
        {
			mkdir("../files/semester2/".$kdemtr, 0775);
        }
		...
		{
			$newfile= "../files/semester2/$kdemtr/$nmamt.$type[1]";
			if (file_exists($newfile))
				unlink($newfile);
			copy($pdf, "../files/semester2/$kdemtr/$nmamt.$type[1]");
		}
		echo"<meta http-equiv='refresh' content=\"0;url=guru.php?mode=R1D01H2&kdemtr=$kdemtr&pilihan=tambah_item\">\n";
	}
