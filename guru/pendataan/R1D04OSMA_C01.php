...
while($y<$x)
{
	...
	$pdf->Cell( 7.7	,0.5,'Compulsory Mathematics'		,'LRTB',0,L,true);
	...
	$pdf->Cell( 7.7	,0.5,'History'		,'LRTB',0,L,true);
	$pdf->Cell( 2.5	,0.5,'71'		,'LRTB',0,C,true);//$nKKMhist
	$pdf->Cell( 1.5	,0.5,$qK		,'LRTB',0,C,true);
	//$pdf->SetFillColor(0, 183, 235);
	$pdf->Cell( 2	,0.5,$lgK		,'LRTB',0,C,true);
	$pdf->SetFillColor(255, 255, 255);
	...
	$pdf->SetFont('Arial','B',11);
	$pdf->Cell( 0.6	,0.5,''			,'LTB',0,C,true);
	$pdf->Cell( 7.7	,0.5,'SCIENCES'		,'TB',0,L,true);
	$pdf->Cell( 2.5	,0.5,''		,'TB',0,C,true);
	$pdf->Cell( 7	,0.5,''		,'RTB',0,C,true);
	$pdf->SetFillColor(255, 255, 255);
	...
	$pdf->Cell( 7.7	,0.5,'Physics'		,'LRTB',0,L,true);
	...
	$pdf->Cell( 7.7	,0.5,'Biology'		,'LRTB',0,L,true);
	...
	$pdf->Cell( 7.7	,0.5,'Chemistry'		,'LRTB',0,L,true);
	$pdf->Cell( 2.5	,0.5,$nKKMchm		,'LRTB',0,C,true);
	$pdf->Cell( 1.5	,0.5,$qK		,'LRTB',0,C,true);
	//$pdf->SetFillColor(0, 183, 235);
	$pdf->Cell( 2	,0.5,$lgK		,'LRTB',0,C,true);
	$pdf->SetFillColor(255, 255, 255);
	...
	$pdf->Cell( 7.7	,0.5,'Supplementary Mathematics'		,'LRTB',0,L,true);
	$pdf->Cell( 2.5	,0.5,'70'		,'LRTB',0,C,true);//$nKKMsmth
	$pdf->Cell( 1.5	,0.5,$qK		,'LRTB',0,C,true);
	//$pdf->SetFillColor(0, 183, 235);
	$pdf->Cell( 2	,0.5,$lgK		,'LRTB',0,C,true);
	$pdf->SetFillColor(255, 255, 255);
