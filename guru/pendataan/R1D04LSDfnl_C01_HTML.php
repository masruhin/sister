...
if($sms=='2')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04LSDfnl2_C01_HTML.php?kdekls=$kdekls&kdeplj=$kdeplj\">\n";
...
while($j<$i)
{
	...
	while($dataX =mysql_fetch_array($resultX))
	{
		...
		{
			$cRLG[$i][0]=$dRLG['st'.'1'.'1'."9"]; // K
			$cRLG[$i][1]=$dRLG['st_'.'1'.'1'."9"]; // S
			
			$cRLG[$i][2]=$dRLG['st'.'1'.'2'."9"]; // K
			$cRLG[$i][3]=$dRLG['st_'.'1'.'2'."9"]; // S
			
			$cRLG[$i][4]=$dRLG['fgk'.'1'.'1']; // K
			$cRLG[$i][5]=$dRLG['fgs'.'1'.'1']; // S
			
			$cRLG[$i][6]=$dRLG['fgk'.'1'.'2']; // K
			$cRLG[$i][7]=$dRLG['fgs'.'1'.'2']; // S
		}
		...
		{
			$cCME[$i][0]=$dCME['st'.'1'.'1'."9"]; // K
			$cCME[$i][1]=$dCME['st_'.'1'.'1'."9"]; // S
			
			$cCME[$i][2]=$dCME['st'.'1'.'2'."9"]; // K
			$cCME[$i][3]=$dCME['st_'.'1'.'2'."9"]; // S
			
			$cCME[$i][4]=$dCME['fgk'.'1'.'1']; // K
			$cCME[$i][5]=$dCME['fgs'.'1'.'1']; // S
			
			$cCME[$i][6]=$dCME['fgk'.'1'.'2']; // K
			$cCME[$i][7]=$dCME['fgs'.'1'.'2']; // S
		}
		...
		{
			$cBIN[$i][0]=$dBIN['st'.'1'.'1'."9"]; // K
			$cBIN[$i][1]=$dBIN['st_'.'1'.'1'."9"]; // S
			
			$cBIN[$i][2]=$dBIN['st'.'1'.'2'."9"]; // K
			$cBIN[$i][3]=$dBIN['st_'.'1'.'2'."9"]; // S
			
			$cBIN[$i][4]=$dBIN['fgk'.'1'.'1']; // K
			$cBIN[$i][5]=$dBIN['fgs'.'1'.'1']; // S
			
			$cBIN[$i][6]=$dBIN['fgk'.'1'.'2']; // K
			$cBIN[$i][7]=$dBIN['fgs'.'1'.'2']; // S
		}
		...
		{
			$cMTH[$i][0]=$dMTH['st'.'1'.'1'."9"]; // K
			$cMTH[$i][1]=$dMTH['st_'.'1'.'1'."9"]; // S
			
			$cMTH[$i][2]=$dMTH['st'.'1'.'2'."9"]; // K
			$cMTH[$i][3]=$dMTH['st_'.'1'.'2'."9"]; // S
			
			$cMTH[$i][4]=$dMTH['fgk'.'1'.'1']; // K
			$cMTH[$i][5]=$dMTH['fgs'.'1'.'1']; // S
			
			$cMTH[$i][6]=$dMTH['fgk'.'1'.'2']; // K
			$cMTH[$i][7]=$dMTH['fgs'.'1'.'2']; // S
		}
		...
		{
			$cSCN[$i][0]=$dSCN['st'.'1'.'1'."9"]; // K
			$cSCN[$i][1]=$dSCN['st_'.'1'.'1'."9"]; // S
			
			$cSCN[$i][2]=$dSCN['st'.'1'.'2'."9"]; // K
			$cSCN[$i][3]=$dSCN['st_'.'1'.'2'."9"]; // S
			
			$cSCN[$i][4]=$dSCN['fgk'.'1'.'1']; // K
			$cSCN[$i][5]=$dSCN['fgs'.'1'.'1']; // S
			
			$cSCN[$i][6]=$dSCN['fgk'.'1'.'2']; // K
			$cSCN[$i][7]=$dSCN['fgs'.'1'.'2']; // S
		}
		...
		{
			$cSCLS[$i][0]=$dSCLS['st'.'1'.'1'."9"]; // K
			$cSCLS[$i][1]=$dSCLS['st_'.'1'.'1'."9"]; // S
			
			$cSCLS[$i][2]=$dSCLS['st'.'1'.'2'."9"]; // K
			$cSCLS[$i][3]=$dSCLS['st_'.'1'.'2'."9"]; // S
			
			$cSCLS[$i][4]=$dSCLS['fgk'.'1'.'1']; // K
			$cSCLS[$i][5]=$dSCLS['fgs'.'1'.'1']; // S
			
			$cSCLS[$i][6]=$dSCLS['fgk'.'1'.'2']; // K
			$cSCLS[$i][7]=$dSCLS['fgs'.'1'.'2']; // S
		}
		...
		{
			$cART[$i][0]=$dART['st'.'1'.'1'."9"]; // K
			$cART[$i][1]=$dART['st_'.'1'.'1'."9"]; // S
			
			$cART[$i][2]=$dART['st'.'1'.'2'."9"]; // K
			$cART[$i][3]=$dART['st_'.'1'.'2'."9"]; // S
			
			$cART[$i][4]=$dART['fgk'.'1'.'1']; // K
			$cART[$i][5]=$dART['fgs'.'1'.'1']; // S
			
			$cART[$i][6]=$dART['fgk'.'1'.'2']; // K
			$cART[$i][7]=$dART['fgs'.'1'.'2']; // S
		}
		...
		{
			$cCOM[$i][0]=$dCOM['st'.'1'.'1'."9"]; // K
			$cCOM[$i][1]=$dCOM['st_'.'1'.'1'."9"]; // S
			
			$cCOM[$i][2]=$dCOM['st'.'1'.'2'."9"]; // K
			$cCOM[$i][3]=$dCOM['st_'.'1'.'2'."9"]; // S
			
			$cCOM[$i][4]=$dCOM['fgk'.'1'.'1']; // K
			$cCOM[$i][5]=$dCOM['fgs'.'1'.'1']; // S
			
			$cCOM[$i][6]=$dCOM['fgk'.'1'.'2']; // K
			$cCOM[$i][7]=$dCOM['fgs'.'1'.'2']; // S
		}
		...
		{
			$cPE[$i][0]=$dPE['st'.'1'.'1'."9"]; // K
			$cPE[$i][1]=$dPE['st_'.'1'.'1'."9"]; // S
			
			$cPE[$i][2]=$dPE['st'.'1'.'2'."9"]; // K
			$cPE[$i][3]=$dPE['st_'.'1'.'2'."9"]; // S
			
			$cPE[$i][4]=$dPE['fgk'.'1'.'1']; // K
			$cPE[$i][5]=$dPE['fgs'.'1'.'1']; // S
			
			$cPE[$i][6]=$dPE['fgk'.'1'.'2']; // K
			$cPE[$i][7]=$dPE['fgs'.'1'.'2']; // S
		}
		...
		{
			$cENG[$i][0]=$dENG['st'.'1'.'1'."9"]; // K
			$cENG[$i][1]=$dENG['st_'.'1'.'1'."9"]; // S
			
			$cENG[$i][2]=$dENG['st'.'1'.'2'."9"]; // K
			$cENG[$i][3]=$dENG['st_'.'1'.'2'."9"]; // S
			
			$cENG[$i][4]=$dENG['fgk'.'1'.'1']; // K
			$cENG[$i][5]=$dENG['fgs'.'1'.'1']; // S
			
			$cENG[$i][6]=$dENG['fgk'.'1'.'2']; // K
			$cENG[$i][7]=$dENG['fgs'.'1'.'2']; // S
		}
		...
		{
			$cMND[$i][0]=$dMND['st'.'1'.'1'."9"]; // K
			$cMND[$i][1]=$dMND['st_'.'1'.'1'."9"]; // S
			
			$cMND[$i][2]=$dMND['st'.'1'.'2'."9"]; // K
			$cMND[$i][3]=$dMND['st_'.'1'.'2'."9"]; // S
			
			$cMND[$i][4]=$dMND['fgk'.'1'.'1']; // K
			$cMND[$i][5]=$dMND['fgs'.'1'.'1']; // S
			
			$cMND[$i][6]=$dMND['fgk'.'1'.'2']; // K
			$cMND[$i][7]=$dMND['fgs'.'1'.'2']; // S
		}
	...
	while($j<$i AND $x<=30)
	{
		...
		//RLG
		//AWAL BUATAN BARU
		$nmassw_d = $cellX[$x-1][1];
		
		echo"
			<tr>
				<td align='center' title='Religion Q1 $x. $nmassw_d'>
					$q1RLG
				</td>
				<td align='center' title='Religion Q2 $x. $nmassw_d'>
					$q2RLG
				</td>
				<td align='center' title='Religion AV $x. $nmassw_d' bgcolor='pink'>
					$avRLG
				</td>
		...
		echo"
				...
				<td align='center' title='CME Q1 $x. $nmassw_d'>
					$q1CME
				</td>
				<td align='center' title='CME Q2 $x. $nmassw_d'>
					$q2CME
				</td>
				<td align='center' title='CME AV $x. $nmassw_d' bgcolor='pink'>
					$avCME
				</td>
		...
		echo"
				...
				<td align='center' title='Bhs. Indo. Q1 $x. $nmassw_d'>
					$q1BIN
				</td>
				<td align='center' title='Bhs. Indo. Q2 $x. $nmassw_d'>
					$q2BIN
				</td>
				<td align='center' title='Bhs. Indo. AV $x. $nmassw_d' bgcolor='pink'>
					$avBIN
				</td>
		...
		echo"
				...
				<td align='center' title='Maths Q1 $x. $nmassw_d'>
					$q1MTH
				</td>
				<td align='center' title='Maths Q2 $x. $nmassw_d'>
					$q2MTH
				</td>
				<td align='center' title='Maths AV $x. $nmassw_d' bgcolor='pink'>
					$avMTH
				</td>
		...
		echo"
				...
				<td align='center' title='Science Q1 $x. $nmassw_d'>
					$q1SCN
				</td>
				<td align='center' title='Science Q2 $x. $nmassw_d'>
					$q2SCN
				</td>
				<td align='center' title='Science AV $x. $nmassw_d' bgcolor='pink'>
					$avSCN
				</td>
		...
		echo"
				...
				<td align='center' title='Social Q1 $x. $nmassw_d'>
					$q1SCLS
				</td>
				<td align='center' title='Social Q2 $x. $nmassw_d'>
					$q2SCLS
				</td>
				<td align='center' title='Social AV $x. $nmassw_d' bgcolor='pink'>
					$avSCLS
				</td>
		...
		echo"
				...
				<td align='center' title='Art Q1 $x. $nmassw_d'>
					$q1ART
				</td>
				<td align='center' title='Art Q2 $x. $nmassw_d'>
					$q2ART
				</td>
				<td align='center' title='Art AV $x. $nmassw_d' bgcolor='pink'>
					$avART
				</td>
		...
		echo"
				...
				<td align='center' title='Computer Q1 $x. $nmassw_d'>
					$q1COM
				</td>
				<td align='center' title='Computer Q2 $x. $nmassw_d'>
					$q2COM
				</td>
				<td align='center' title='Computer AV $x. $nmassw_d' bgcolor='pink'>
					$avCOM
				</td>
		...
		echo"
				...
				<td align='center' title='PE Q1 $x. $nmassw_d'>
					$q1PE
				</td>
				<td align='center' title='PE Q2 $x. $nmassw_d'>
					$q2PE
				</td>
				<td align='center' title='PE AV $x. $nmassw_d' bgcolor='pink'>
					$avPE
				</td>
		...
		echo"
				...
				<td align='center' title='English Q1 $x. $nmassw_d'>
					$q1ENG
				</td>
				<td align='center' title='English Q2 $x. $nmassw_d'>
					$q2ENG
				</td>
				<td align='center' title='English AV $x. $nmassw_d' bgcolor='pink'>
					$avENG
				</td>
		...
		echo"
				...
				<td align='center' title='Mandarin Q1 $x. $nmassw_d'>
					$q1MND
				</td>
				<td align='center' title='Mandarin Q2 $x. $nmassw_d'>
					$q2MND
				</td>
				<td align='center' title='Mandarin AV $x. $nmassw_d' bgcolor='pink'>
					$avMND
				</td>
			</tr>
		";
	...
	echo"
		...
		<tr>
			...
			<td align='center' bgcolor='lightgrey' title='Religion'>
				<b>$aveRLG</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey' title='CME'>
				<b>$aveCME</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey' title='Bhs. Indo.'>
				<b>$aveBIN</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey'  title='Maths'>
				<b>$aveMTH</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey' title='Science'>
				<b>$aveSCN</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey'  title='Social'>
				<b>$aveSCLS</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey' title='Art'>
				<b>$aveART</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey' title='Computer'>
				<b>$aveCOM</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey' title='PE'>
				<b>$avePE</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey' title='English'>
				<b>$aveENG</b>
			</td>
			...
			<td align='center' bgcolor='lightgrey' title='Mandarin'>
				<b>$aveMND</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td align='center' bgcolor='lightblue' title='Religion'>
				<b>$maxRLG</b>
			</td>
			...
			<td align='center' bgcolor='lightblue' title='CME'>
				<b>$maxCME</b>
			</td>
			...
			<td align='center' bgcolor='lightblue' title='Bhs. Indo.'>
				<b>$maxBIN</b>
			</td>
			...
			<td align='center' bgcolor='lightblue'  title='Maths'>
				<b>$maxMTH</b>
			</td>
			...
			<td align='center' bgcolor='lightblue' title='Science'>
				<b>$maxSCN</b>
			</td>
			...
			<td align='center' bgcolor='lightblue'  title='Social'>
				<b>$maxSCLS</b>
			</td>
			...
			<td align='center' bgcolor='lightblue' title='Art'>
				<b>$maxART</b>
			</td>
			...
			<td align='center' bgcolor='lightblue' title='Computer'>
				<b>$maxCOM</b>
			</td>
			...
			<td align='center' bgcolor='lightblue' title='PE'>
				<b>$maxPE</b>
			</td>
			...
			<td align='center' bgcolor='lightblue' title='English'>
				<b>$maxENG</b>
			</td>
			...
			<td align='center' bgcolor='lightblue' title='Mandarin'>
				<b>$maxMND</b>
			</td>
		</tr>
		...
		<tr>
			...
			<td align='center' bgcolor='lightgreen' title='Religion'>
				<b>$minRLG</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen' title='CME'>
				<b>$minCME</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen' title='Bhs. Indo.'>
				<b>$minBIN</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen'  title='Maths'>
				<b>$minMTH</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen' title='Science'>
				<b>$minSCN</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen'  title='Social'>
				<b>$minSCLS</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen' title='Art'>
				<b>$minART</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen' title='Computer'>
				<b>$minCOM</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen' title='PE'>
				<b>$minPE</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen' title='English'>
				<b>$minENG</b>
			</td>
			...
			<td align='center' bgcolor='lightgreen' title='Mandarin'>
				<b>$minMND</b>
			</td>
		</tr>
	";
	...
	*/
	...
	while($data = mysql_fetch_array($result))
	{
		...
		$set	="	SET	t_smscp_sd.kdekls='". mysql_escape_string($kdekls)."',
					...
					t_smscp_sd.avekls1	=	'". mysql_escape_string($avekls[$i][1])."',
					t_smscp_sd.maxkls1	=	'". mysql_escape_string($maxkls[$i][2])."',
					t_smscp_sd.minkls1	=	'". mysql_escape_string($minkls[$i][3])."',
