<?php 
//----------------------------------------------------------------------------------------------------
//Program		: R1D04PSMA12_C01.php
//Di Edit oleh	: ITPCS
//Tanggal Edit	: 07/12/2011
//Keterangan	: Cetak SISWA ( versi 1 lembar ) rapot sma 12 ipa
//----------------------------------------------------------------------------------------------------
...
while($y<$x)
{
	...
	$qCME ="	SELECT 		t_prgrptps_sma_p.*
				...
				WHERE		t_prgrptps_sma_p.nis='$nis'		AND
							t_prgrptps_sma_p.thn_ajaran='$thn_ajr'		AND
	...
	$smav1CME='';
	if($akh2CME==0)//$ahw2CME
		$smav1CME=$akh1CME;//$ahw1CME
	else
	{
	...
	$fgt1BLGY	=$dBLGY['fgt'."1"."1"];
	$fgt2BLGY	=$dBLGY['fgt'."1"."2"];
	$fgt3BLGY	=$dBLGY['fgt'."2"."1"];
	$fgt4BLGY	=$dBLGY['fgt'."2"."2"];
	$fgp1BLGY	=$dBLGY['fgp'."1"."1"];
	$fgp2BLGY	=$dBLGY['fgp'."1"."2"];
	$fgp3BLGY	=$dBLGY['fgp'."2"."1"];
	$fgp4BLGY	=$dBLGY['fgp'."2"."2"];
	$akh1BLGY	=$dBLGY['akh'."1"."1"];
	$akh2BLGY	=$dBLGY['akh'."1"."2"];
	$akh3BLGY	=$dBLGY['akh'."2"."1"];
	$akh4BLGY	=$dBLGY['akh'."2"."2"];
	$aff1BLGY	=$dBLGY['aff'."1"."1"];
	$aff2BLGY	=$dBLGY['aff'."1"."2"];
	$aff3BLGY	=$dBLGY['aff'."2"."1"];
	$aff4BLGY	=$dBLGY['aff'."2"."2"];
	...
	{
		$smav1BLGY = number_format( ($akh1BLGY+$akh2BLGY)/2 ,0,',','.' );
	}
	...
	$qCHM ="	SELECT 		t_prgrptps_sma.*
				...
				WHERE		t_prgrptps_sma.nis='$nis'		AND
							t_prgrptps_sma.thn_ajaran='$thn_ajr'		AND	
							t_prgrptps_sma.kdeplj='CHM'"; // menghasilka per siswa per subjek (nilai akhir q1/q2/q3/q4)
	$rCHM=mysql_query($qCHM) or die('Query gagal');
	$dCHM =mysql_fetch_array($rCHM);
	$fgt1CHM	=$dCHM['fgt'."1"."1"];
	$fgt2CHM	=$dCHM['fgt'."1"."2"];
	$fgt3CHM	=$dCHM['fgt'."2"."1"];
	$fgt4CHM	=$dCHM['fgt'."2"."2"];
	$fgp1CHM	=$dCHM['fgp'."1"."1"];
	$fgp2CHM	=$dCHM['fgp'."1"."2"];
	$fgp3CHM	=$dCHM['fgp'."2"."1"];
	$fgp4CHM	=$dCHM['fgp'."2"."2"];
	$akh1CHM	=$dCHM['akh'."1"."1"];
	$akh2CHM	=$dCHM['akh'."1"."2"];
	$akh3CHM	=$dCHM['akh'."2"."1"];
	$akh4CHM	=$dCHM['akh'."2"."2"];
	$aff1CHM	=$dCHM['aff'."1"."1"];
	$aff2CHM	=$dCHM['aff'."1"."2"];
	$aff3CHM	=$dCHM['aff'."2"."1"];
	$aff4CHM	=$dCHM['aff'."2"."2"];
	...
	{
		$smav1CHM = number_format( ($akh1CHM+$akh2CHM)/2 ,0,',','.' );
	}
	...
	$fgt1PHY	=$dPHY['fgt'."1"."1"];
	$fgt2PHY	=$dPHY['fgt'."1"."2"];
	$fgt3PHY	=$dPHY['fgt'."2"."1"];
	$fgt4PHY	=$dPHY['fgt'."2"."2"];
	$fgp1PHY	=$dPHY['fgp'."1"."1"];
	$fgp2PHY	=$dPHY['fgp'."1"."2"];
	$fgp3PHY	=$dPHY['fgp'."2"."1"];
	$fgp4PHY	=$dPHY['fgp'."2"."2"];
	$akh1PHY	=$dPHY['akh'."1"."1"];
	$akh2PHY	=$dPHY['akh'."1"."2"];
	$akh3PHY	=$dPHY['akh'."2"."1"];
	$akh4PHY	=$dPHY['akh'."2"."2"];
	$aff1PHY	=$dPHY['aff'."1"."1"];
	$aff2PHY	=$dPHY['aff'."1"."2"];
	$aff3PHY	=$dPHY['aff'."2"."1"];
	$aff4PHY	=$dPHY['aff'."2"."2"];
	...
	{
		$smav1PHY = number_format( ($akh1PHY+$akh2PHY)/2 ,0,',','.' );
	}
	...
	$pdf->Cell( 0.75	,0.5,$fgt3RLG,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3RLG,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3RLG,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3RLG,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3RLG,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,$akh3CME,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3CME,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3CME,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,$fgt3BIN,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3BIN,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3BIN,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3BIN,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3BIN,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,$fgt3ENG,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3ENG,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3ENG,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3ENG,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3ENG,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,$akh3MTH,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3MTH,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3MTH,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,$fgt1BLGY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp1BLGY,'LRTB',0,C,true);
	$pdf->SetFont('Arial','B',8);
	$pdf->Cell( 0.75	,0.5,$akh1BLGY,'LRTB',0,C,true);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell( 0.75	,0.5,$fgt2BLGY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp2BLGY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh2BLGY,'LRTB',0,C,true);//$akh2BLGY
	$pdf->Cell( 0.75	,0.5,$smav1BLGY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg1BLGY,'LRTB',0,C,true);
	
	$pdf->Cell( 0.75	,0.5,$fgt3BLGY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3BLGY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3BLGY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3BLGY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3BLGY,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,$fgt1CHM,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp1CHM,'LRTB',0,C,true);
	$pdf->SetFont('Arial','B',8);
	$pdf->Cell( 0.75	,0.5,$akh1CHM,'LRTB',0,C,true);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell( 0.75	,0.5,$fgt2CHM,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp2CHM,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh2CHM,'LRTB',0,C,true);//$akh2CHM
	$pdf->Cell( 0.75	,0.5,$smav1CHM,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg1CHM,'LRTB',0,C,true);
	
	$pdf->Cell( 0.75	,0.5,$fgt3CHM,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3CHM,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3CHM,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3CHM,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3CHM,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,$fgt1PHY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp1PHY,'LRTB',0,C,true);
	$pdf->SetFont('Arial','B',8);
	$pdf->Cell( 0.75	,0.5,$akh1PHY,'LRTB',0,C,true);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell( 0.75	,0.5,$fgt2PHY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp2PHY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh2PHY,'LRTB',0,C,true);//$akh2PHY
	$pdf->Cell( 0.75	,0.5,$smav1PHY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg1PHY,'LRTB',0,C,true);
	
	$pdf->Cell( 0.75	,0.5,$fgt3PHY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3PHY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3PHY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3PHY,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3PHY,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,$akh3HIST,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3HIST,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3HIST,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,$akh3ART,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3ART,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3ART,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,$fgt3PE,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3PE,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3PE,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3PE,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3PE,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,$fgt3ICT,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3ICT,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3ICT,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3ICT,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3ICT,'LRTB',0,C,true);
	...
	$pdf->Cell( 0.75	,0.5,$fgt3FOR,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$fgp3FOR,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3FOR,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$akh3FOR,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,$lg3FOR,'LRTB',0,C,true);
	...
	$pdf->Cell( 7.45	,0.4,'Basketball','LRTB',0,L,true);//$nmaPil1
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$ktr1c		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr1c		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	...
	$pdf->Cell( 7.45	,0.4,'Futsal','LRTB',0,L,true);//$nmaPil1
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$ktr2c		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr2c		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	...
	$q1BDM=$dBDM['ext'."1"."1"]; // q1 BDM
	$q2BDM=$dBDM['ext'."1"."2"]; // q2 BDM
	$q3BDM=$dBDM['ext'."2"."1"]; // q1 BDM
	if($q1BDM!='')
	{
		$nma3a='BADMINTON';
		$ktr3a=$q1BDM;
	...
	$pdf->Cell( 7.45	,0.4,'Badminton /Table Tennis','LRTB',0,L,true);//$nmaPil1
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$ktr3c		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr3c		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	...
	$pdf->Cell( 7.45	,0.4,'Culinary Art','LRTB',0,L,true);//$nmaPil2
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$ktr4c		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr4c		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	...
	$q3CLB=$dCLB['ext'."2"."1"]; // q1 CLB
	if($q1CLB!='')
	{
		$nma5a='Math Club / English Club';
		$ktr5a=$q1CLB;
	}
	if($q2CLB!='')
	{
		$nma5b='Math Club / English Club';
		$ktr5b=$q2CLB;
	}
	if($q3CLB!='')
	{
		$nma5c='Math Club / English Club';
		$ktr5c=$q3CLB;
	}
	//av1
	$ave5a='';
	...
	$pdf->Cell( 7.45	,0.4,'Math Club / English Club','LRTB',0,L,true);//$nmaPil5
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$ktr5c		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr5c		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	...
	$pdf->Cell( 2.25	,0.4,$ktr6a		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,$ktr6b		,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ave6a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$ktr6c		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr6c		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	...
	//chess
	$qCHS	="	SELECT 		t_extcrrps.*
				FROM 		t_extcrrps
				WHERE		t_extcrrps.nis='$nis'	AND
							t_extcrrps.thn_ajaran='$thn_ajr'	AND
							t_extcrrps.kdeplj='CHS' "; // extra kurikuler
	$rCHS=mysql_query($qCHS) or die('Query gagal40');
	$dCHS =mysql_fetch_array($rCHS);
	$q1CHS=$dCHS['ext'."1"."1"]; // q1 CHS
	$q2CHS=$dCHS['ext'."1"."2"]; // q2 CHS
	$q3CHS=$dCHS['ext'."2"."1"]; // q1 CHS
	if($q1CHS!='')
	{
		$nma7a='English Circle / German/Chess';
		$ktr7a=$q1CHS;
	}
	if($q2CHS!='')
	{
		$nma7b='English Circle / German/Chess';
		$ktr7b=$q2CHS;
	}
	if($q3CHS!='')
	{
		$nma7c='English Circle / German/Chess';
		$ktr7c=$q3CHS;
	}
	//av1
	$ave7a='';
	...
	$pdf->Cell( 7.45	,0.4,'English Circle / German/Chess','LRTB',0,L,true);//$nmaPil3
	$pdf->Cell( 2.25	,0.4,$ktr7a		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,$ktr7b		,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ave7a		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$ktr7c		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$ktr7c		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	...
	$q3ATT=$dPER['att'."2"."1"]; // q1 att
	$q3DIL=$dPER['dil'."2"."1"]; // q1 dil
	$q3ORD=$dPER['ord'."2"."1"]; // q1 ord
	$q3CLE=$dPER['cle'."2"."1"]; // q1 cle
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$q3ATT		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q3ATT		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Ln();
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$q3DIL		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q3DIL		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Ln();
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$q3ORD		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q3ORD		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Ln();
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$q3CLE		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q3CLE		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	...
	$q3SKT=$dABS['skt'."2"."1"]; // q1 skt
	$q3IZN=$dABS['izn'."2"."1"]; // q1 izn
	$q3ALP=$dABS['alp'."2"."1"]; // q1 alp
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$q3SKT		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q3SKT		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Ln();
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$q3IZN		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''		,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q3IZN		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Ln();
	...
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell( 2.25	,0.4,$q3ALP		,'LRTB',0,C,true);
	$pdf->Cell( 2.25	,0.4,''			,'LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.4,$q3ALP		,'LRTB',0,C,true);
	$pdf->SetFillColor(204,204,204);
	$pdf->Cell( 0.75	,0.4,''			,'LRTB',0,C,true);
	$pdf->SetFillColor(255,255,255);
	$pdf->Ln(0.6);
	...
	$pdf->Cell( 2	,0);
	//$pdf->Image($signature, 8.25, 25.5, 4.577234, 2.143098);
	$pdf->Cell( 7	,0.4,'','',0,C);
	$pdf->Cell( 1	,0);
