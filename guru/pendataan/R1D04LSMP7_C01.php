...
if($sms=='2')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04LSMP7b_C01.php?kdekls=$kdekls\">\n";
...
//{
	...
	$pdf->Cell(1.2, 0.6, "RAPOT", '', 0, C, true);
	$pdf->Ln(0.6);
	$pdf->Cell( 9.3	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, "SEKOLAH MENENGAH PERTAMA", '', 0, C, true);
	$pdf->Ln(0.6);
	$pdf->Cell( 9.3	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, "( S M P )", '', 0, C, true);
	
	$pdf->Ln(1.5);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "NAMA SEKOLAH", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "Saint John's School ", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "NPSN", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "20177837", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "NISN/NSS/NDS", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, $nisn, '', 0, L, true);//"0051173685"
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "ALAMAT SEKOLAH", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "Jl. Taman Palem Raya Blok D1 No. 1, Villa Meruya", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "", '', 0, L, false);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(2, 1.2, "KODE POS ", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(0.1, 1.2, ": ", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1, 1.2, " 11650", '', 0, L, true);
	$pdf->Cell( 0.4	,1.2,'','',0,C,false);
	$pdf->Cell(1, 1.2, "Telp : ", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1, 1.2, "021-58902398", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "KELURAHAN", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "Meruya Selatan", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "KECAMATAN", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "Kembangan", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "KABUPATEN/KOTA", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "Kodya Jakarta Barat", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "PROVINSI", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "DKI Jakarta", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "WEBSITE", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "www.saintjohn.sch.id", '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "E-MAIL", '', 0, L, true);
	$pdf->Cell( 4	,1.2,'','',0,C,false);
	$pdf->Cell(0.25, 1.2, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,1.2,'','',0,C,false);
	$pdf->Cell(1.2, 1.2, "saintjohnschoolhsmeruya@gmail.com", '', 0, L, true);
	...
	$pdf->Ln(5);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "1", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Nama Peserta Didik", '', 0, L, true);
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "2", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Nomor Induk Siswa Nasional", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $nisn, '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "3", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Tempat Tanggal Lahir", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "4", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Jenis Kelamin", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "5", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Agama", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "", '', 0, L, false);
	$pdf->Cell(1.2, 0.6, "Status dalam Keluarga", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $status, '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "6", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Anak ke", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "7", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Alamat Peserta Didik", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "8", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Nomor Telp/HP", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $hpaayh, '', 0, L, true);
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "9", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Sekolah Asal", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $sklasl, '', 0, L, true);//Saint John's School Meruya
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "10", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Diterima di Sekolah ini", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, "", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	...
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "a.   Di Kelas", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $dikelas, '', 0, L, true);
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "b.   Pada Tanggal", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $pdatgl, '', 0, L, true);//13 Juli 2017
	
	$pdf->Ln(1);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "11", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Orang Tua", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, "", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, '', '', 0, L, true);
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "a.   Nama Ayah", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $nmaayh, '', 0, L, true);//7
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "b.   Nama Ibu", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $nmaibu, '', 0, L, true);//13 Juli 2017
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "c.   Alamat Orang Tua", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $almt, '', 0, L, true);
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "d.   Nomor Telpon", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $hpaayh, '', 0, L, true);
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "12", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Pekerjaan Orang Tua", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, "", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, '', '', 0, L, true);
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "a.   Ayah", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $pkjayh, '', 0, L, true);//7
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "b.   Ibu", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $pkjibu, '', 0, L, true);//13 Juli 2017
	
	$pdf->Ln(1);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(0.5, 0.6, "13", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "Wali Peserta Didik", '', 0, L, true);
	$pdf->Cell( 5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, "", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, '', '', 0, L, true);
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "a.   Nama", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "b.   Alamat", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $almwli, '', 0, L, true);
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "c.   Nomor Telp/hp", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $hpawli, '', 0, L, true);
	...
	$pdf->Cell(0.5, 0.6, "", '', 0, L, true);
	$pdf->Cell(0.4, 0.6, "", '', 0, L, true);
	$pdf->Cell(1.2, 0.6, "d.   Pekerjaan", '', 0, L, true);
	$pdf->Cell( 4.5	,0.6,'','',0,C,false);
	$pdf->Cell(0.25, 0.6, ":", '', 0, L, true);
	$pdf->Cell( 0.1	,0.6,'','',0,C,false);
	$pdf->Cell(1.2, 0.6, $pkjwli, '', 0, L, true);
	
	$signature	="../../images/".$kkelas."/".$nisn.".jpg";
	$pdf->Image($signature, 2, 23, 3.5, 4);
	
	$pdf->Ln(2);
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(12.5, 0.6, "", '', 0, L, false);
	$pdf->Cell(1.2, 0.6, '13 Juli 2017', '', 0, L, true);//$tglctk
	
	$pdf->Ln();
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell( 1.3	,0.6,'','',0,C,false);
	$pdf->Cell(12.5, 0.6, "", '', 0, L, false);
	$pdf->Cell(1.2, 0.6, 'Kepala Sekolah,', '', 0, L, true);
	...
	$pdf->Cell(1.2, 0.6, 'Ir. Paulus Pontoh MBA', '', 0, L, true);
	...
	$pdf->Cell( 2	,0.4,''			,'LR',0,C,false);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell( 8.5	,0.4,substr($IPAk1,100,50)			,'LR',0,L,true);
