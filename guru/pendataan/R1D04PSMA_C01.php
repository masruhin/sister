...
if($sms=='1' AND $midtrm=='2')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04PSMA_C01_2.php?kdekls=$kdekls\">\n";
if($sms=='2' AND $midtrm=='1')
	echo"<meta http-equiv='refresh' content=\"0;url=R1D04PSMA_C01_3.php?kdekls=$kdekls\">\n";
...
while($y<$x)
{
	...
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);
	$pdf->Cell( 0.75	,0.5,'','LRTB',0,C,true);//$akh2ENG
	$pdf->Cell( 0.75	,0.5,$akh1ENG,'LRTB',0,C,true);
