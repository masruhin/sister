    ...
    // -------------------------------------------------- Cetak Daftar --------------------------------------------------
 	...
 	{   
		...
		//-----Validasi kelas----//
           ...
           <SCRIPT TYPE='text/javascript' src='../guru/js/R1D04K.js'></SCRIPT>
		";
		//----End Validasi Kelas---//
		...
		<FORM ID='validasi' ACTION='pendataan/R1D04K_C01.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
  			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
        		<TR><TD COLSPAN='2'><B>PRINT GRADING SHEET</B></TD></TR>
           		<TR></TR><TR></TR>
