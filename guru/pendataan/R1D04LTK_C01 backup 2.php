...
//{
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(1.5	, 0.4, $q1nliB[1][0], 'LRT', 0, C, true);
	$pdf->Cell(1.5	, 0.4, $q2nliB[1][0], 'LRT', 0, C, true);
	$pdf->Cell(2.75	, 0.4, $smstr1B[1][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->SetFillColor(255,255,255);							$pdf->Cell(0.5	, 0.4, "1", 'LT', 0, C, true);									$pdf->Cell(7	, 0.4, substr( $nmektr3[0][0] ,0,53 ), 'RT', 0, J, true);								$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.4, $q1nliC[1][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.4, $q2nliC[1][0], 'LRT', 0, C, true);	$pdf->Cell(2.75	, 0.4, $smstr1C[1][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(2.75	, 0.4, $smstr1B[5][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 2.25	,0.8,'','',0,C,false);					$pdf->SetFillColor(153,153,153);							$pdf->Cell(13.25, 0.4, "B. Calculating", 'LRT', 0, L, true);
	...
	$pdf->Cell(2.75	, 0.8, $smstr1B[6][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "4", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[3][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[4][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[4][0], 'LRT', 0, C, true);	$pdf->Cell(2.75	, 0.8, $smstr1C[4][0], 'LRT', 0, C, true);
	//6
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[5][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[3][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(2.75	, 0.4, $smstr1B[7][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "5", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[4][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[5][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[5][0], 'LRT', 0, C, true);	$pdf->Cell(2.75	, 0.8, $smstr1C[5][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(2.75	, 0.4, $smstr1B[8][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[4][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(2.75	, 0.4, $smstr1B[9][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "6", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[5][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[6][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[6][0], 'LRT', 0, C, true);	$pdf->Cell(2.75	, 0.8, $smstr1C[6][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(2.75	, 0.4, $smstr1B[10][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[5][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->SetFont('Arial','BU',11);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.25, 0.4, "Mandarin", 'LRT', 0, L, true);										$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->SetFillColor(255,255,255);							$pdf->Cell(0.5	, 0.4, "7", 'LT', 0, C, true);									$pdf->Cell(7	, 0.4, substr( $nmektr3[6][0] ,0,53 ), 'RT', 0, J, true);								$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[7][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[7][0], 'LRT', 0, C, true);	$pdf->Cell(2.75	, 0.8, $smstr1C[7][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(2.75	, 0.4, $smstr1B[11][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[6][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(2.75	, 0.4, $smstr1B[12][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "8", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[7][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 1.2, $q1nliC[8][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 1.2, $q2nliC[8][0], 'LRT', 0, C, true);	$pdf->Cell(2.75	, 1.2, $smstr1C[8][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(2.75	, 0.8, $smstr1B[13][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[7][0] ,53,53 ), 'R', 0, J, true);
	//3
	$pdf->Ln(0.4);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[12][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[7][0] ,106,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(2.75	, 0.4, $smstr1B[14][0], 'LRT', 0, C, true);									$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "9", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[8][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[9][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[9][0], 'LRT', 0, C, true);	$pdf->Cell(2.75	, 0.8, $smstr1C[9][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(2.75	, 0.8, $smstr1B[15][0], 'LRTB', 0, C, true);								$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[8][0] ,53,53 ), 'R', 0, J, true);
	//5
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[14][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','BU',11);	$pdf->Cell( 8	,0.8,'','',0,C,false);						$pdf->SetFillColor(153,153,153);							$pdf->Cell(13.25, 0.4, "C. Shape, Space and Measure", 'LRT', 0, L, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(1.5	, 0.8, $q1nliB[16][0], 'LRTB', 0, C, true);
	$pdf->Cell(1.5	, 0.8, $q2nliB[16][0], 'LRTB', 0, C, true);
	$pdf->Cell(2.75	, 0.8, $smstr1B[16][0], 'LRTB', 0, C, true);								$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "10", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[9][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[10][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[10][0], 'LRT', 0, C, true);		$pdf->Cell(2.75	, 0.8, $smstr1C[10][0], 'LRT', 0, C, true);
	//6
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->SetFillColor(255,255,255);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[15][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[9][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(2.75	, 0.8, $smstr1B[17][0], 'LRTB', 0, C, true);								$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "11", 'LT', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[10][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[11][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[11][0], 'LRT', 0, C, true);		$pdf->Cell(2.75	, 0.8, $smstr1C[11][0], 'LRT', 0, C, true);
	//7
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[16][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[10][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(1.5	, 0.8, $q1nliB[18][0], 'LRTB', 0, C, true);
	$pdf->Cell(1.5	, 0.8, $q2nliB[18][0], 'LRTB', 0, C, true);
	$pdf->Cell(2.75	, 0.8, $smstr1B[18][0], 'LRTB', 0, C, true);								$pdf->SetFont('Arial','',8);	$pdf->Cell(2.25	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "12", 'LT', 0, C, true);			$pdf->Cell(7	, 0.4, substr( $nmektr3[11][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.4, $q1nliC[12][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.4, $q2nliC[12][0], 'LRT', 0, C, true);		$pdf->Cell(2.75	, 0.4, $smstr1C[12][0], 'LRT', 0, C, true);
	//8
	$pdf->Ln(0.4);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[17][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "13", 'LT', 0, C, true);			$pdf->Cell(7	, 0.4, substr( $nmektr3[12][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.4, $q1nliC[13][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.4, $q2nliC[13][0], 'LRT', 0, C, true);		$pdf->Cell(2.75	, 0.4, $smstr1C[13][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(2.75	, 0.8, $smstr1B[19][0], 'LRTB', 0, C, true);								$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "14", 'LT', 0, C, true);			$pdf->Cell(7	, 0.4, substr( $nmektr3[13][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[14][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[14][0], 'LRT', 0, C, true);		$pdf->Cell(2.75	, 0.8, $smstr1C[14][0], 'LRT', 0, C, true);
	//9
	$pdf->Ln(0.4);
	$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[18][0] ,53,53 ), 'R', 0, J, true);					$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[13][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(2.75	, 0.8, $smstr1B[20][0], 'LRTB', 0, C, true);								$pdf->SetFont('Arial','',8);	$pdf->Cell( 2.25	,0.4,'','',0,C,false);				$pdf->SetFillColor(255,255,255);							$pdf->Cell(0.5	, 0.4, "15", 'LT', 0, C, true);								$pdf->Cell(7	, 0.4, substr( $nmektr3[14][0] ,0,53 ), 'RT', 0, J, true);								$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[15][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[15][0], 'LRT', 0, C, true);		$pdf->Cell(2.75	, 0.8, $smstr1C[15][0], 'LRT', 0, C, true);
	//10
	$pdf->Ln(0.4);
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(0.5	, 0.4, "", 'LB', 0, C, true);
	$pdf->Cell(7	, 0.4, substr( $nmektr2[19][0] ,53,53 ), 'RB', 0, J, true);					$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[14][0] ,53,53 ), 'R', 0, J, true);
	...
	$pdf->Cell(7	, 0.4, "", '', 0, J, false);												$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);					$pdf->Cell(0.5	, 0.4, "16", 'LT', 0, C, true);			$pdf->Cell(7	, 0.4, substr( $nmektr3[15][0] ,0,53 ), 'RT', 0, J, true);																												$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 0.8, $q1nliC[16][0], 'LRT', 0, C, true);		$pdf->Cell(1.5	, 0.8, $q2nliC[16][0], 'LRT', 0, C, true);		$pdf->Cell(2.75	, 0.8, $smstr1C[16][0], 'LRT', 0, C, true);
	...
	$pdf->Cell(7	, 0.4, "", '', 0, J, false);												$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->SetFillColor(255,255,255);							$pdf->Cell(0.5	, 0.4, "17", 'LT', 0, C, true);								$pdf->Cell(7	, 0.4, substr( $nmektr3[16][0] ,0,53 ), 'RT', 0, J, true);								$pdf->SetFont('Arial','',11);					$pdf->Cell(1.5	, 1.6, $q1nliC[17][0], 'LRTB', 0, C, true);		$pdf->Cell(1.5	, 1.6, $q2nliC[17][0], 'LRTB', 0, C, true);		$pdf->Cell(2.75	, 1.6, $smstr1C[17][0], 'LRTB', 0, C, true);
	
	$pdf->Ln(0.4);
	$pdf->Cell(0.5	, 0.4, "", '', 0, C, false);
	$pdf->Cell(7	, 0.4, "", '', 0, J, false);												$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[16][0] ,53,53 ), 'R', 0, J, true);
	
	$pdf->Ln(0.4);
	$pdf->Cell(0.5	, 0.4, "", '', 0, C, false);	
	$pdf->Cell(7	, 0.4, "", '', 0, J, false);												$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'L', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[16][0] ,106,53 ), 'R', 0, J, true);
	
	$pdf->Ln(0.4);
	$pdf->Cell(0.5	, 0.4, "", '', 0, C, false);
	$pdf->Cell(7	, 0.4, "", '', 0, J, false);												$pdf->SetFont('Arial','',8);	$pdf->Cell( 8	,0.4,'','',0,C,false);						$pdf->Cell(0.5	, 0.4, "", 'LB', 0, C, true);				$pdf->Cell(7	, 0.4, substr( $nmektr3[16][0] ,159,53 ), 'RB', 0, J, true);
	...
	$pdf->SetFont('Arial','BU',10);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.25, 0.4, "A. Exploring Media and Art Materials", 'LRT', 0, L, true);			$pdf->SetFont('Arial','BU',10);	$pdf->Cell( 2.25	,0.8,'','',0,C,false);					$pdf->SetFillColor(153,153,153);							$pdf->Cell(13.25, 0.4, "A. Listening and Speaking", 'LRT', 0, L, true);
	...
	$pdf->SetFont('Arial','BU',10);
	$pdf->SetFillColor(153,153,153);
	$pdf->Cell(13.25, 0.4, "A. Gross Motor Development", 'LRT', 0, L, true);					$pdf->SetFont('Arial','BU',10);	$pdf->Cell( 2.25	,0.8,'','',0,C,false);					$pdf->SetFillColor(153,153,153);							$pdf->Cell(13.25, 0.4, "B. Reading and Writing", 'LRT', 0, L, true);
