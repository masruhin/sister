...
$query1	=" 	SELECT 		g_dtlrpp.*,t_mstkry.*
			...
			WHERE 		g_dtlrpp.kderpp='$kderpp'AND
...
{   $id     =$data1['id'];
	...
	<TR onMouseOver=\"this.className='highlight'\" onMouseOut=\"this.className='normal'\">
        ...
        echo"
        <TD WIDTH='	7%'><CENTER><a href='../files/rpp/$kderpp/$nmarpp2.$type'target='_blank'>
        ...
        {
        echo"
		<TD WIDTH=' 7%'><CENTER><a href='#' id='$data1[id]'typ='$type' nmamt='$nmarpp2'class='hapusrpp'>
