...
{   //Disable/Enable
		...
		$(".stt1").click(function()
	{
        ...
        //var nmamtr = $("#nmamtr2").val();
		{
			$.ajax(
			{
				...
				{
					window.location.href='guru.php?mode=R1D01G&kdemtr='+kdemtr+'&pilihan=tambah_item';
	...
	$(".kdeklm").change(function()
	{
                    ...
                    $.ajax(
		{
            ...
            url: "../guru/fungsi_khusus/R1D01G_kdemtr.php",
			data: dataString,
			cache: false,
			success: function(msg)
			{
				...
				$('#kdemtr').val(msg);
					...
					$('#materi').load("../guru/fungsi_khusus/R1D01G_materi.php?kdeklm="+kdeklm+"&kdeplj="+kdeplj+"&kdegru="+kdegru);
