...
{   //Disable/Enable
		...
		$(".stt1").click(function()
	{
        ...
        //var nmamtr = $("#nmamtr2").val();
		{
			...
			{
				type: "GET",
				url: "../guru/fungsi_khusus/R1D01Q_Update.php",
				data: info,
				success: function(msg)
				{
					window.location.href='guru.php?mode=R1D01Q&kdemtr='+kdemtr+'&pilihan=tambah_item';
    ...
    $(".kdeplj").change(function()
			{
    			...
    			$.ajax(
    			{
        			url: "../guru/fungsi_khusus/R1D01Q_kls.php",
        			data: dataString,
    	    		success: function(msg)
        			{
	...
	$(".kdeklm").change(function()
	{
                    ...
                    $.ajax(
		{
            ...
            url: "../guru/fungsi_khusus/R1D01Q_kdemtr.php",
			data: dataString,
			cache: false,
			success: function(msg)
			{
				...
				$('#kdemtr').val(msg);
					...
					$('#materi').load("../guru/fungsi_khusus/R1D01Q_materi.php?kdeklm="+kdeklm+"&kdeplj="+kdeplj+"&kdegru="+kdegru);
	...
	$("#sub").click(function() 
	{
		...
		else
		{
			...
			{
				type: "POST",
				url: "guru.php?mode=R1D01Q_SaveD",
				data: dataString,
				success: function()
				{
					document.f1.kdeplj.disabled=true;
