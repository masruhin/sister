...
{
	$('#tglbmb').blur(function()
	{
		//remove all the class add the messagebox classes and start fading
		$('#msgbox').removeClass().addClass('messagebox').text('Checking...').fadeIn('1000');
		//check the username exists or not from ajax
		$.post('../penjualan/fungsi_khusus/J1D03_validasi_tglbmbj.php',{ tglbmb:$(this).val() } ,function(data)
		{
			...
			else
			{
				...
				{
					//add message and change the class of the box and start fading
					$(this).html('Bulan dan Tahun sama dengan Periode..').addClass('messageboxok').fadeTo(300,1).fadeOut(700,1);
				});
			}
		});
	});
