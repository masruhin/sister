...
class J6U03class
{
	...
	function J6U03_Edit() 
	{
		...
		<FORM ACTION=penjualan.php METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
			<TABLE BORDER='0' CELLPADDING='0' CELLSPACING='5' WIDTH='100%'>
				...
				<TR></TR><TR></TR>
				<TR><TD WIDTH=25%>Password Baru</TD>
					<TD WIDTH=75%>: <INPUT TYPE=password NAME=password SIZE=30> * (Diisi bila ingin dirubah)</TD>
				</TR>
				...
				<TR><TD COLSPAN=2 >
					...
					<INPUT TYPE=hidden NAME=mode 	VALUE=J6U03_Save>
					</TD>
				</TR>
			</TABLE>
		</FORM>";  
	...
	function J6U03_Save() 
	{
		...
		if($password <> $password2 or $password=='') 
		{
			...
			echo"
			<meta http-equiv='refresh' content=\"0;url=penjualan.php?mode=J6U03_Edit\">\n"; 		
		}
		else
		{ 
