...
//Keterangan	: Fungsi-fungsi LAPORAN KARTU STOCK
//----------------------------------------------------------------------------------------------------
if(!defined("sister"))
{
...
{	
	...
	function J5L04()
	{
		...
		echo"
		<FORM ACTION='laporan/J5L04_Cetak.php' target=_blank METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
			<TABLE  BORDER='0' CELLSPACING='5' CELLPADDING='5' BORDERCOLOR='#000000' WIDTH='100%'>
				<TR><TD COLSPAN='2'><B>LAPORAN KARTU STOCK</B></TD></TR>
				<TR></TR><TR></TR>
