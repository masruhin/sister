...
class T6U03class
{
	...
	function T6U03_Edit() 
	{
		...
		<FORM ACTION='tatausaha.php' METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
			...
			<INPUT TYPE=hidden NAME=mode 	VALUE=T6U03_Save>
		</FORM>";  
	}
	...
	function T6U03_Save() 
	{
		...
		if($password <> $password2 or $password=='') 
		{
			...
			echo"<meta http-equiv='refresh' content=\"0;url=tatausaha.php?mode=T6U03_Edit\">\n"; 		
		}
		else
		{ 
			...
			echo"<meta http-equiv='refresh' content='1; url=tatausaha.php'>\n"; 
		}
	}
}
?>