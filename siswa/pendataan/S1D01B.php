...
class S1D01Bclass
{
	...
	function S1D01B()
	{
		...
		echo"<SCRIPT TYPE='text/javascript' 		src='../siswa/js/S1D01B.js'></SCRIPT>";
						...
						<div style='overflow:auto;width:100%;height:380px;padding-right:-2px;'>                
							<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='0' CELLSPACING='0' WIDTH='100%' >
								<TR bgcolor='dedede'>
									...
									<TD WIDTH='96%'><CENTER>Tugas  	</CENTER></TD>
								</TR>
								<TABLE BORDER='0' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='5' WIDTH='100%' id='tugas'>
								</TABLE>
							</TABLE>
						</DIV>
					</TD>
