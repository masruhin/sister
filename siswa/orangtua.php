		...
		else
		{
			...
			<TABLE ALIGN=CENTER WIDTH='100%' BORDER='0' BORDERCOLOR='#ffffff' CELLPADDING='0' CELLSPACING='0'>
				<TR><TD ALIGN='left' 	WIDTH='50' HEIGHT='20'	BGCOLOR='#fcc012'><B>&nbsp&nbsp&nbsp$modul</B></TD>
					<TD ALIGN='right'							BGCOLOR='#fcc012'><FONT class='adminhead'>Selamat Datang <B>ORANG TUA SISWA-$user ( $induk - $kelas )</B> - Tanggal : <B>$tgl</B> - Jam :&nbsp</FONT></TD>
			...
			<TABLE ALIGN=CENTER	WIDTH='100%' BORDER='0' CELLPADDING='0' CELLSPACING='0'>
				<TR BGCOLOR='#E6E7E9' HEIGHT='20'>";
					...
					// -------------------------------------------------- Menu --------------------------------------------------
					echo"
					<TD WIDTH='800' ALIGN='left' onclick='clickOpenMenu(\"pf\"); return false;' style='cursor: pointer;'>
					<ul id='nav' class='dropdown dropdown-horizontal'>
					<li><a href='orangtua.php'><IMG src='../images/home.png' WIDTH='10' ALIGN='absmiddle'>&nbspHome</a></li>
					<li><a href='orangtua.php?mode=S1D02'>Hasil Test</a></li>
					<li><a href='orangtua.php?mode=S1D03'>Kehadiran</a></li>
					...
					<li><a href='orangtua.php?mode=S6U01OT'>Ganti Password</a></li>
