			...
			<TABLE ALIGN=CENTER WIDTH='100%' BORDER='0' BORDERCOLOR='#ffffff' CELLPADDING='0' CELLSPACING='0'>
                ...
                <TR>
                    ...
                    <td ALIGN='left' width='55%' VALIGN='TOP'>
						...
						<marquee onmouseout='this.start()' direction='up' scrollamount='1' height='250' onmouseover='this.stop()' bgcolor='#000000' style='border:0px solid #000000; padding-left: 0px; padding-right: 0px; padding-top:0px; padding-bottom:0px; background-color:#FFFFFF' width='100%'>
						<font color='#C60101' size='3'><b>Selamat Datang...</b><br><br>
						Untuk mendapatkan training penggunaan program bisa menghubungi Bagian IT, <br><br>
						Untuk mendapatkan penjelasan lebih rinci tentang MENU bisa dilihat pada <b>tutorial</b> <br>
						(ada di menu dalam program di kanan bawah)<br><br>
						salam<br>
						Kantor Pusat</i>
						</marquee>
						</div>
                    ...
                    <TD ALIGN='CENTER' width='25%' VALIGN='TOP'>
                        ...
                        <FORM METHOD="POST"  name="f1"ACTION="index.php">
							<TABLE BORDER ="0" CELLSPACING="0" CELLPADDING="0">
								...
								<TR><TD HEIGHT='20'><FONT class='adminhead2'><i>* hubungi bagian tata usaha jika lupa</i></font></TD></TR>
							</TABLE>
                            </FORM>
						</DIV>
                        </TD>
						...
						<?php
						echo"
				<TR><TD></TD><TD HEIGHT='10' BGCOLOR='#ffffff'><FONT class='adminhead'>Copyright &copy 2012 - SAINT JOHN'S SCHOOL</FONT></TD>
...
<?php
	...
	else
	{
        ...
        $ret1 		=mysql_query("	SELECT 	*
									FROM  t_mstkry
									WHERE 	kdekry	='".mysql_escape_string($username)."'
											 limit 0,1");
       while($dt=mysql_fetch_array($ret1))
       {
		...
		$ret 		=mysql_query("	SELECT 	*
									FROM  t_mstkry
									WHERE 	kdekry	='".mysql_escape_string($username)."' 		AND
         ...
         if (@mysql_num_rows($ret) != 0)
		{
			...
			$q						=mysql_query("	UPDATE  user
              	...
              	echo"<center><b>Selamat Datang $nmakry</b><br>
                 <img src='../images/ajax-loader.gif'></center>";
         ...
         if (@mysql_num_rows($ret) != 0)
		{
			...
			$q						=mysql_query("	UPDATE  user
              	...
              	echo"<center><b>Selamat Datang Orang Tua $nmassw</b><br>
                 <img src='../images/ajax-loader.gif'></center>";
		...
		if (@mysql_num_rows($ret) != 0)
		{
			...
			$q						=mysql_query("	UPDATE  user
             	...
             	echo"<center><b>Selamat Datang $nmassw</b><br>
                 <img src='../images/ajax-loader.gif'></center>";
