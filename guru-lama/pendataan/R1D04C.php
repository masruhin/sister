...
class R1D04Cclass
{
	...
	function R1D04C_Cari()
	{
		...
		<FORM ACTION='guru.php?mode=R1D04C' METHOD='post'>
				...
				<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='0' WIDTH='100%'>
					...
					while($data =mysql_fetch_array($result))
					{
						...
						<TR onMouseOver=\"this.className='highlight'\" onMouseOut=\"this.className='normal'\">
							<TD>$data[nmaplj]</TD>
							<TD><CENTER><a href='guru.php?mode=R1D04C&kdeplj=$data[kdeplj]'><IMG src='../images/detil_e.gif' BORDER='0'></a></CENTER></TD>
						</TR>";
					}
				echo"	
				</TABLE>
			...
			<TR>
				<TD WIDTH='30%' valign='top'>
					<FORM ACTION='guru.php' METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
							...
							<TABLE BORDER='1' BORDERCOLOR='#000000' CELLPADDING='5' CELLSPACING='0' WIDTH='100%'>
								...
								{   
									...
									<TR onMouseOver=\"this.className='highlight'\" onMouseOut=\"this.className='normal'\">
										...
										<TD>$nmassw</TD>
										<TD>
											<CENTER><a href='guru.php?mode=R1D04C&kdeplj=$kdeplj&kdekls=$kdekls&nis=$data[nis]'>
						...
						<INPUT TYPE='button' 	VALUE='Pelajaran' 	onClick=window.location.href='guru.php?mode=R1D04C_Cari'>
					</FORM>
				</TD>
				...
				<TD WIDTH='70%' valign='top'>";
					...
					if($nis!='')
					{
						...
						$query ="	SELECT 		t_indbhvps.*,t_setpsbhv.*,t_mstssw.nmassw
									...
									ORDER BY	t_indbhvps.nis,t_indbhvps.id";
						$result =mysql_query($query);
					...
					<FORM ACTION='guru.php' METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
						...
						{
							echo"
							<INPUT TYPE='button'	VALUE='Edit' 	onClick=window.location.href='guru.php?mode=R1D04C&kdeplj=$kdeplj&kdekls=$kdekls&nis=$nisv&pilihan=edit'>";
							echo"
							<INPUT TYPE='button'	VALUE='Seting Term per kelas' 	onClick=window.location.href='guru.php?mode=R1D04C&kdeplj=$kdeplj&kdekls=$kdekls&nis=$nisv&pilihan=seting'>";
						}	
	...
	function R1D04C_Save()
	{
		...
		echo"<meta http-equiv='refresh' content=\"0;url=guru.php?mode=R1D04C&kdeplj=$kdeplj&kdekls=$kdekls&nis=$nis&pilihan=detil\">\n";
 	}		
