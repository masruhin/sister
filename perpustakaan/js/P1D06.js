$(function() 
{
	...
	$(".kdeang").change(function() 
	{
		...
		else
		{
			...
			{
				type: "POST",
				url: "perpustakaan.php?mode=P1D06_Save",
				data: dataString,
				success: function()
				{
    	...
    	{
			type: "GET",
            url: "../perpustakaan/fungsi_khusus/P1D06_nmasiswa.php?kdeang="+kdeang,
            data: dataString,
        	cache: false,
	...
	$(".kdebku").change(function() 
	{
		...
		else
		{
			...
			{
				type: "POST",
				url: "perpustakaan.php?mode=P1D06_Save_Item",
				data: dataString,
				success: function(msg)
				{
					document.f1.kdebku.focus();
					document.f1.kdebku.value='';
					$('#kdebku').html(msg);
					$('#pjm').load("../perpustakaan/fungsi_khusus/P1D06_pinjaman.php?nmrpjm="+nmrpjm);
				}
			});
		}
		return false;
