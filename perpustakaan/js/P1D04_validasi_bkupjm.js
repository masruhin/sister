...
$(document).ready(function()
{
	$('.kdebku').keyup(function()
	{
		...
		$.post('../perpustakaan/fungsi_khusus/P1D04_validasi_bkupjm.php',{ kdebku:$(this).val() } ,function(data)
		{
	...
	{
		//check the username exists or not from ajax
		$.post('../perpustakaan/fungsi_khusus/P1D04_validasi_tglk.php',{ kdebku:$(this).val() } ,function(data)
		{
			if(data=='yes') //if username not avaiable
			{
	...
	{
		//check the username exists or not from ajax
		$.post('../perpustakaan/fungsi_khusus/P1D04_validasi_siswa.php',{ kdeang:$(this).val() } ,function(data)
		{
			if(data=='yes') //if username not avaiable
			{
	...
	{
		//check the username exists or not from ajax
		$.post('../perpustakaan/fungsi_khusus/P1D04_validasi_kde.php',{ kdeang:$(this).val() } ,function(data)
		{
			if(data=='yes') //if username not avaiable
			{
