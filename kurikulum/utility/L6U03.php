...
class L6U03class
{
	...
	function L6U03_Edit() 
	{
		...
		<FORM ACTION='kurikulum.php' METHOD='post' NAME='f1' ENCTYPE='multipart/form-data'>
			...
			<INPUT TYPE=hidden NAME=mode 	VALUE=L6U03_Save>
		</FORM>";  
	}
	...
	function L6U03_Save() 
	{
		...
		if($password <> $password2 or $password=='') 
		{
			...
			echo"<meta http-equiv='refresh' content=\"0;url=kurikulum.php?mode=L6U03_Edit\">\n"; 		
		}
		else
		{ 
			...
			echo"<meta http-equiv='refresh' content='1; url=kurikulum.php'>\n"; 
		}
	}
}
?>