...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../files/files_tiny_mce/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../files/files_tiny_mce/');	//accept relative path only
